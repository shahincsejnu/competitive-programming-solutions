...
<head>
    ...
    <meta name="X-Csrf-Token" content="dd7031b76624d9491df5ba12d57d29c7"/>
    ...
    <meta property="og:title" content="Submission #58549323 - Codeforces"/>
    ...
    <meta name="cc" content="ea2042ac924340603d0429fea10e6db030474783"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #58549323 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='dd7031b76624d9491df5ba12d57d29c7'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F86%2Fsubmission%2F58549323">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='dd7031b76624d9491df5ba12d57d29c7'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/86">Problems</a></li>
        <li><a
                                        href="/contest/86/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/86/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/86/status">Status</a></li>
        <li><a
                                        href="/contest/86/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/86/room/1">Room</a></li>
        <li><a
                                        href="/contest/86/standings">Standings</a></li>
        <li><a
                                        href="/contest/86/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="D - Powerful array" href="/contest/86/problem/D">86D</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-58549323" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
lli block_size;
lli mp[1000005], arr[200005], res[200005];
struct _info
{
	lli L, R, id;
};

bool compare(_info left, _info right)
{
	if(left.L/block_size != right.L/block_size) return left.L/block_size < right.L/block_size;
...
int main()
{
	...
	block_size = (lli) sqrt(n+.0) + 1;
	
	sort(query, query+q, compare);
	
	lli currL = 0, currR = 0, l, r;
	lli val, total = 0;
