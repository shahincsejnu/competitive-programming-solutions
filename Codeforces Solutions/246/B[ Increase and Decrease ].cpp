...
<head>
    ...
    <meta name="X-Csrf-Token" content="7953119cf9759f9f5c02ee6a23b655ea"/>
    ...
    <meta property="og:title" content="Submission #55402658 - Codeforces"/>
    ...
    <title>Submission #55402658 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='7953119cf9759f9f5c02ee6a23b655ea'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F246%2Fsubmission%2F55402658">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='7953119cf9759f9f5c02ee6a23b655ea'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-55402658" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
	...
	for(int i = 0; i < n-1; i++) sum += (a[n-1] - a[i]);
