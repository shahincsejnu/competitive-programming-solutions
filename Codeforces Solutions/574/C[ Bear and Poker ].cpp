...
<head>
    ...
    <meta name="X-Csrf-Token" content="2a9d047c4aa92a016e743ea15b7d932a"/>
    ...
    <meta property="og:title" content="Submission #72214479 - Codeforces"/>
    ...
    <meta name="cc" content="fd135256b2ad24bb6680dd43b49276d44cb1577f"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #72214479 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='2a9d047c4aa92a016e743ea15b7d932a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F574%2Fsubmission%2F72214479">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='2a9d047c4aa92a016e743ea15b7d932a'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-72214479" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
	...
	for(int i = 0; i < n; i++){
		...
		if(common == -1) common = val;
		else if(common != val) flag = 1;
	}
