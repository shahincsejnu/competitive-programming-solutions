...
<head>
    ...
    <meta name="X-Csrf-Token" content="31a25213b65546bdd751a48aefd3dd38"/>
    ...
    <meta property="og:title" content="Submission #54545297 - Codeforces"/>
    ...
    <title>Submission #54545297 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='31a25213b65546bdd751a48aefd3dd38'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F134%2Fsubmission%2F54545297">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='31a25213b65546bdd751a48aefd3dd38'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="A - Average Numbers" href="/contest/134/problem/A">134A</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-54545297" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
//  freopen("output.txt", "w", stdout);
    ...
    for(int i = 0; i < n; i++){
        ...
        if(mean == a[i] && !(sum%(n-1))) v.push_back(i+1);
        sum += a[i];
    }
