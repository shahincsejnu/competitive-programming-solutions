...
<head>
    ...
    <meta name="X-Csrf-Token" content="b76437f9ecd795c17c0863e1acac7615"/>
    ...
    <meta property="og:title" content="Submission #78613291 - Codeforces"/>
    ...
    <title>Submission #78613291 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='b76437f9ecd795c17c0863e1acac7615'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F260%2Fsubmission%2F78613291">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b76437f9ecd795c17c0863e1acac7615'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Ancient Prophesy" href="/contest/260/problem/B">260B</a>
    ...
    <td>2020-05-01 03:29:01</td>
    <td>2020-05-01 03:29:04</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78613291" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
bool Good(string s)
{
    ...
    if(year >= 2013 && year <= 2015 && month >= 1 && month <= 12 && day >= 1 && day <= dates[month]) return true;
