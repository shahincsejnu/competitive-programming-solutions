...
<head>
    ...
    <meta name="X-Csrf-Token" content="d48426dd2e96fb851f55fb9ab8a1a7d5"/>
    ...
    <meta property="og:title" content="Submission #35960155 - Codeforces"/>
    ...
    <title>Submission #35960155 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='d48426dd2e96fb851f55fb9ab8a1a7d5'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F350%2Fsubmission%2F35960155">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d48426dd2e96fb851f55fb9ab8a1a7d5'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="A - TL" href="/contest/350/problem/A">350A</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-35960155" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    int n, m, mn_o = INT_MAX, mx_o = INT_MIN, mn_t = INT_MAX;
    ...
    int ans = max(mx_o, 2*mn_o);

    if(ans >= mn_t) cout << -1 << endl;
    else cout << ans << endl;
