...
<head>
    ...
    <meta name="X-Csrf-Token" content="df6997e3f19d87bd5c3b065b57385d0a"/>
    ...
    <meta property="og:title" content="Submission #81902776 - Codeforces"/>
    ...
    <meta name="cc" content="5957e83a74bab90558a303956efdc45e9dbd5492"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #81902776 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='df6997e3f19d87bd5c3b065b57385d0a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F350%2Fsubmission%2F81902776">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='df6997e3f19d87bd5c3b065b57385d0a'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/350">Problems</a></li>
        <li><a
                                        href="/contest/350/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/350/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/350/status">Status</a></li>
        <li><a
                                        href="/contest/350/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/350/room/1">Room</a></li>
        <li><a
                                        href="/contest/350/standings">Standings</a></li>
        <li><a
                                        href="/contest/350/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="C - Bombs" href="/contest/350/problem/C">350C</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-81902776" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
bool myfunc(const pair<int,int> &i, const pair<int,int> &j)
{
    int val1 = abs(i.first) + abs(i.second);
    int val2 = abs(j.first) + abs(j.second);
...
void solve()
{
    ...
    cout << cnt << "\n";
    for(int i = 0; i < cnt; i++){
        if(vv[i].first == &#39;X&#39;) cout << vv[i].second.first << "\n";
        else cout << vv[i].second.first << " " << vv[i].second.second << " " << vv[i].first << "\n";
    }
}
