...
<head>
    ...
    <meta name="X-Csrf-Token" content="93cb38daf8da784b3d5f6bd904633d56"/>
    ...
    <meta property="og:title" content="Submission #71420951 - Codeforces"/>
    ...
    <title>Submission #71420951 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='93cb38daf8da784b3d5f6bd904633d56'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F550%2Fsubmission%2F71420951">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='93cb38daf8da784b3d5f6bd904633d56'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-71420951" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
	...
	if((aba && bab) || (ab && ba) || (aba && ab) || (aba && ba) || (bab && ab) || (bab && ba)) cout << "YES" << "\n";
	else cout << "NO" << "\n";
