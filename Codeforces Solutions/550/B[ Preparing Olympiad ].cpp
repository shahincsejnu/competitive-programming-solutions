...
<head>
    ...
    <meta name="X-Csrf-Token" content="ff2a79490594d2d9bbfd5b7be1c59df4"/>
    ...
    <meta property="og:title" content="Submission #77381447 - Codeforces"/>
    ...
    <meta name="cc" content="a43e40a6947611cc9f0324fd9065c6353e54666d"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #77381447 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='ff2a79490594d2d9bbfd5b7be1c59df4'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F550%2Fsubmission%2F77381447">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ff2a79490594d2d9bbfd5b7be1c59df4'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Preparing Olympiad" href="/contest/550/problem/B">550B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-77381447" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    lli sum = 0, cnt = 0, mn, mx;

    for(int i = 0; i < (1<<n); i++){
        sum = 0; mn = 1e9+5; mx = -1;

        for(int j = 0; j < n; j++){
            if((1<<j)&i) {mn = min(mn, arr[j]); mx = max(mx, arr[j]); sum += arr[j];}
        }

        if((mx-mn >= x) && (sum >= l && sum <= r)) cnt++;
    }
