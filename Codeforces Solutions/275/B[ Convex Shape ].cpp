...
<head>
    ...
    <meta name="X-Csrf-Token" content="a643e27531ae1918313f621dea96216c"/>
    ...
    <meta property="og:title" content="Submission #80929820 - Codeforces"/>
    ...
    <meta name="cc" content="5acddd352f5c5852a1c8a3d6756bb0763e1685c1"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #80929820 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='a643e27531ae1918313f621dea96216c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F275%2Fsubmission%2F80929820">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a643e27531ae1918313f621dea96216c'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Convex Shape" href="/contest/275/problem/B">275B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-80929820" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
void DFS(int x, int y)
{
    ...
    if(visited[x][y] || ch[x][y] == &#39;W&#39;) return;
    visited[x][y] = 1;
...
int main()
{
    ...
    int flag = 0, cnt, cnt2 = 0;
    
    for(int i = 1; i <= n; i++){
        for(int j = 1; j <= m; j++){
            if(ch[i][j] == &#39;B&#39; && !visited[i][j]){
                cnt2++;
                DFS(i, j);
            }
        }
    ...
    for(int i = 1; i <= n; i++){
        cnt = -1;
        for(int j = 1; j <= m; j++){
            if(ch[i][j] == &#39;W&#39; && cnt == 0) cnt = 1;
            if(ch[i][j] == &#39;B&#39; && cnt == -1) cnt = 0;
            if(ch[i][j] == &#39;B&#39; && cnt == 1) flag = 1;
        }
    }
    for(int i = 1; i <= m; i++){
        cnt = -1;
        for(int j = 1; j <= n; j++){
            if(ch[j][i] == &#39;W&#39; && cnt == 0) cnt = 1;
            if(ch[j][i] == &#39;B&#39; && cnt == -1) cnt = 0;
            if(ch[j][i] == &#39;B&#39; && cnt == 1) flag = 1;
        }
    }
