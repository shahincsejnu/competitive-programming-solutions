...
<head>
    ...
    <meta name="X-Csrf-Token" content="0f4f81e0c4b3ffbb1b69c65cb6e16a64"/>
    ...
    <meta property="og:title" content="Submission #55412738 - Codeforces"/>
    ...
    <meta name="cc" content="51d0ff2f1952a3db78d96d2f1643d1c413fb8de1"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #55412738 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='0f4f81e0c4b3ffbb1b69c65cb6e16a64'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F254%2Fsubmission%2F55412738">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0f4f81e0c4b3ffbb1b69c65cb6e16a64'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/254">Problems</a></li>
        <li><a
                                        href="/contest/254/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/254/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/254/status">Status</a></li>
        <li><a
                                        href="/contest/254/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/254/room/1">Room</a></li>
        <li><a
                                        href="/contest/254/standings">Standings</a></li>
        <li><a
                                        href="/contest/254/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="A - Cards with Numbers" href="/contest/254/problem/A">254A</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-55412738" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
	...
	for(int i = 0; i < n; i++){
		cin >> val;
		v2.push_back(make_pair(val, i+1));
	}
	...
	for(int i = 0; i < n; i += 2){
		if(v2[i].first != v2[i+1].first) {cout << -1 << "\n"; return 0;}
		v.push_back(make_pair(v2[i].second, v2[i+1].second));
	}
	n /= 2;
