...
<head>
    ...
    <meta name="X-Csrf-Token" content="e4141682cef55b28d7d42c87c588edbc"/>
    ...
    <meta property="og:title" content="Submission #78563030 - Codeforces"/>
    ...
    <meta name="cc" content="9988a55ba59bd5e7ba994c2680db0f456cad4bb3"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #78563030 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='e4141682cef55b28d7d42c87c588edbc'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F192%2Fsubmission%2F78563030">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='e4141682cef55b28d7d42c87c588edbc'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/192">Problems</a></li>
        <li><a
                                        href="/contest/192/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/192/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/192/status">Status</a></li>
        <li><a
                                        href="/contest/192/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/192/room/1">Room</a></li>
        <li><a
                                        href="/contest/192/standings">Standings</a></li>
        <li><a
                                        href="/contest/192/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Walking in the Rain" href="/contest/192/problem/B">192B</a>
    ...
    <td>2020-04-30 14:45:52</td>
    <td>2020-04-30 14:45:53</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78563030" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int i = 1; ; i++){
        int flag = 0;
        for(int j = 1; j < n; j++){
            if(j+2 <= n && arr[j+1] < i && arr[j+2] < i) {flag = 1; break;}
            if(j == n-1 && arr[j+1] < i) {flag = 1; break;}
        }
        if(arr[1] < i || arr[n] < i) flag = 1;
