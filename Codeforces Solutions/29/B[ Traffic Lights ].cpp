...
<head>
    ...
    <meta name="X-Csrf-Token" content="67dd7afe19c520813d2389a83a860a0a"/>
    ...
    <meta property="og:title" content="Submission #80997957 - Codeforces"/>
    ...
    <title>Submission #80997957 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='67dd7afe19c520813d2389a83a860a0a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F29%2Fsubmission%2F80997957">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='67dd7afe19c520813d2389a83a860a0a'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Traffic Lights" href="/contest/29/problem/B">29B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-80997957" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    double mn = min(l, d);
    double time = mn/v, extra = floor(time);
    double ex = time - extra;
