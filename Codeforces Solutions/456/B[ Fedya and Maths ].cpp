...
<head>
    ...
    <meta name="X-Csrf-Token" content="8602ae2c8d4f036332d721dd6466b23d"/>
    ...
    <meta property="og:title" content="Submission #72235375 - Codeforces"/>
    ...
    <title>Submission #72235375 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='8602ae2c8d4f036332d721dd6466b23d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F456%2Fsubmission%2F72235375">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='8602ae2c8d4f036332d721dd6466b23d'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-72235375" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
	...
	if(val == 0) ans = 3;
	else if(val == 1 || val == 3) ans = 1;
	else if(val == 2) ans = 4;
	
	val = s[l-1]-&#39;0&#39;;
	val %= 2;
	
	if(val == 0) ans = (ans + 1) % 5;
	if(val == 1) ans = (ans + 4) % 5;
