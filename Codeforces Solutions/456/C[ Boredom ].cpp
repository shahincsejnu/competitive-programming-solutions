...
<head>
    ...
    <meta name="X-Csrf-Token" content="a27e44536cd65df7341428bd1e84585a"/>
    ...
    <meta property="og:title" content="Submission #81025451 - Codeforces"/>
    ...
    <title>Submission #81025451 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='a27e44536cd65df7341428bd1e84585a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F456%2Fsubmission%2F81025451">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a27e44536cd65df7341428bd1e84585a'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="C - Boredom" href="/contest/456/problem/C">456C</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-81025451" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int i = 1; i <= n; i++) {cin >> arr[i]; mp[arr[i]]++; mx = max(mx, arr[i]);}

    lli ans[mx+5] = {0};
    ans[1] = 1ll * mp[1];
    
    for(int i = 2; i <= mx; i++){
        ans[i] = max(ans[i-1], ans[i-2] +  1ll * i * mp[i]);
    }
