...
<head>
    ...
    <meta name="X-Csrf-Token" content="3fc199a48aa9d9a0200f87f441916355"/>
    ...
    <meta property="og:title" content="Submission #81349197 - Codeforces"/>
    ...
    <title>Submission #81349197 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='3fc199a48aa9d9a0200f87f441916355'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F490%2Fsubmission%2F81349197">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='3fc199a48aa9d9a0200f87f441916355'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-81349197" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
void solve()
{
    ...
    int a, b, pos1 = -1, pos2 = -1;
    cin >> a >> b;

    int l = s.size(), arr[l+5] = {0};
