...
<head>
    ...
    <meta name="X-Csrf-Token" content="657d2486f29621f130a1a434f8e616d3"/>
    ...
    <meta property="og:title" content="Submission #78984493 - Codeforces"/>
    ...
    <meta name="cc" content="b67b4a47846e7ce2453bc77148b73acbf5c84773"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #78984493 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='657d2486f29621f130a1a434f8e616d3'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F63%2Fsubmission%2F78984493">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='657d2486f29621f130a1a434f8e616d3'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Settlers' Training" href="/contest/63/problem/B">63B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78984493" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    while(1){
        vector<int> v;
        for(auto it: mp){
            if(it.second && it.first < k) v.push_back(it.first);
        }
