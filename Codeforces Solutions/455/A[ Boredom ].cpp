...
<head>
    ...
    <meta name="X-Csrf-Token" content="dc345120918487f64bc03724bc09005d"/>
    ...
    <meta property="og:title" content="Submission #64346310 - Codeforces"/>
    ...
    <title>Submission #64346310 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='dc345120918487f64bc03724bc09005d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F455%2Fsubmission%2F64346310">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='dc345120918487f64bc03724bc09005d'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-64346310" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
const lli M = 1e5 + 5;
lli arr[M], cnt[M], dp[M];

lli func(lli pos)
{
    if(pos == 0) return 0;
    if(pos == 1) return cnt[pos];

    if(dp[pos] != -1) return dp[pos];

    lli val = max(func(pos-1), func(pos-2) + cnt[pos]*pos);
...
int main()
{
    ...
    for(int i = 1; i <= n; i++) {cin >> arr[i]; cnt[arr[i]]++; mx = max(mx, arr[i]);}
