...
<head>
    ...
    <meta name="X-Csrf-Token" content="f7651082b4f24b70d8ed4875b286fea8"/>
    ...
    <meta property="og:title" content="Submission #78458188 - Codeforces"/>
    ...
    <title>Submission #78458188 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='f7651082b4f24b70d8ed4875b286fea8'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F116%2Fsubmission%2F78458188">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='f7651082b4f24b70d8ed4875b286fea8'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Little Pigs and Wolves" href="/contest/116/problem/B">116B</a>
    ...
    <td>2020-04-29 12:09:31</td>
    <td>2020-04-29 12:09:32</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78458188" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int i = 1; i <= n; i++){
        for(int j = 1; j <= m; j++){
            if(ch[i][j] == &#39;W&#39;){
                ch[i][j] = &#39;.&#39;;
                if(j+1 <= m && ch[i][j+1] == &#39;P&#39;) {ch[i][j+1] = &#39;.&#39;; cnt++;}
                else if(j-1 >= 1 && ch[i][j-1] == &#39;P&#39;) {ch[i][j-1] = &#39;.&#39;; cnt++;}
                else if(i+1 <= n && ch[i+1][j] == &#39;P&#39;) {ch[i+1][j] = &#39;.&#39;; cnt++;}
                else if(i-1 >= 1 && ch[i-1][j] == &#39;P&#39;) {ch[i-1][j] = &#39;.&#39;; cnt++;}
            }
        }
    }
