...
<head>
    ...
    <meta name="X-Csrf-Token" content="77dd1eecac7d2e5d12f90ab3a781265c"/>
    ...
    <meta property="og:title" content="Submission #35182972 - Codeforces"/>
    ...
    <title>Submission #35182972 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='77dd1eecac7d2e5d12f90ab3a781265c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F230%2Fsubmission%2F35182972">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='77dd1eecac7d2e5d12f90ab3a781265c'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-35182972" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int i = 1; i <= n; i++){
        cin >> m;
        sq = sqrt(m);
        if(sq*sq == m && prime[sq] == 0) cout << "YES" << endl;
        else cout << "NO" << endl;
    }
