...
<head>
    ...
    <meta name="X-Csrf-Token" content="10fb61bfb8fe0ef6921adf664f7bab53"/>
    ...
    <meta property="og:title" content="Submission #78553091 - Codeforces"/>
    ...
    <meta name="cc" content="e1b2de2855e2163407ffaadc6b5ee74ee161e994"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #78553091 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='10fb61bfb8fe0ef6921adf664f7bab53'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F214%2Fsubmission%2F78553091">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='10fb61bfb8fe0ef6921adf664f7bab53'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Hometask" href="/contest/214/problem/B">214B</a>
    ...
    <td>2020-04-30 12:42:13</td>
    <td>2020-04-30 12:42:16</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78553091" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    if(d == 1){
        ...
        else if(mp[2] && mp[5]) mp[2]--, mp[5]--;
        else if(mp[5] >= 2) mp[5] -= 2;
        else if(mp[2] && mp[8]) mp[2]--, mp[8]--;
        else if(mp[5] && mp[8]) mp[5]--, mp[8]--;
        ...
        else if(mp[1] && mp[4]) mp[1]--, mp[4]--;
        else if(mp[4] >= 2) mp[4] -= 2;
        else if(mp[1] && mp[7]) mp[1]--, mp[7]--;
        else if(mp[7] && mp[4]) mp[7]--, mp[4]--;
        else if(mp[7] >= 2) mp[7] -= 2;
    }

    for(int i = 1; i <= n; i++){
        if(mp[arr[i]]) {mp[arr[i]]--; ans += arr[i]+&#39;0&#39;;}
    }
