...
<head>
    ...
    <meta name="X-Csrf-Token" content="e512d956aad72ed660b7bbd41a70c42c"/>
    ...
    <meta property="og:title" content="Submission #71354941 - Codeforces"/>
    ...
    <meta name="cc" content="24cd5669805764280a8ed71fdf538f8c89868990"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #71354941 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='e512d956aad72ed660b7bbd41a70c42c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F489%2Fsubmission%2F71354941">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='e512d956aad72ed660b7bbd41a70c42c'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="C - Given Length and Sum of Digits..." href="/contest/489/problem/C">489C</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-71354941" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int i = cnt+1; i <= m; i++) ss += &#39;0&#39;;

    string f = ss;
    reverse(f.begin(), f.end());

    int first = f[0] - &#39;0&#39;, last;
    string ff = f;
