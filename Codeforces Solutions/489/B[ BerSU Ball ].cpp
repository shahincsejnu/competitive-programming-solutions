...
<head>
    ...
    <meta name="X-Csrf-Token" content="e16b41c3352e9d8b0fffc0910a2ad33a"/>
    ...
    <meta property="og:title" content="Submission #63303322 - Codeforces"/>
    ...
    <title>Submission #63303322 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='e16b41c3352e9d8b0fffc0910a2ad33a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F489%2Fsubmission%2F63303322">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='e16b41c3352e9d8b0fffc0910a2ad33a'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <td>2019-10-24 17:53:36</td>
    <td>2019-10-24 17:53:37</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-63303322" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int n, m, arr[500], brr[500], dp[500][500];
...
int func(int pos1, int pos2)
{
	...
	if(abs(arr[pos1] - brr[pos2]) <= 1){
		ans = func(pos1+1, pos2+1) + 1;
	}
	
	left = func(pos1+1, pos2);
	right = func(pos1, pos2+1);
