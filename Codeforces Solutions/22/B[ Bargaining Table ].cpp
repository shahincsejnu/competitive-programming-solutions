...
<head>
    ...
    <meta name="X-Csrf-Token" content="2d07c781953f88d5fb158b40b9358051"/>
    ...
    <meta property="og:title" content="Submission #80986087 - Codeforces"/>
    ...
    <meta name="cc" content="5d46b4c88a867ecf4f998546aa4e11b8573b27e5"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #80986087 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='2d07c781953f88d5fb158b40b9358051'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F22%2Fsubmission%2F80986087">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='2d07c781953f88d5fb158b40b9358051'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/22">Problems</a></li>
        <li><a
                                        href="/contest/22/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/22/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/22/status">Status</a></li>
        <li><a
                                        href="/contest/22/standings">Standings</a></li>
        <li><a
                                        href="/contest/22/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Bargaining Table" href="/contest/22/problem/B">22B</a>
    ...
    <td>2020-05-23 08:37:44</td>
    <td>2020-05-23 08:37:45</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-80986087" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
        ...
        for(int y1 = 1; y1 <= m; y1++){
            for(int x2 = x1; x2 <= n; x2++){
                for(int y2 = y1; y2 <= m; y2++){
                    ...
                    if(!cnt){
                        int res = 2 * (abs(x1-x2) + 1) +  2 * (abs(y1-y2) + 1);
                        mx = max(mx ,res); 
                    }
                }
            }
