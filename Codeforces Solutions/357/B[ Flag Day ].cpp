...
<head>
    ...
    <meta name="X-Csrf-Token" content="2fa37ede8aaf5a6a809726352166474c"/>
    ...
    <meta property="og:title" content="Submission #78465062 - Codeforces"/>
    ...
    <title>Submission #78465062 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='2fa37ede8aaf5a6a809726352166474c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F357%2Fsubmission%2F78465062">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='2fa37ede8aaf5a6a809726352166474c'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <td>2020-04-29 13:31:57</td>
    <td>2020-04-29 13:31:59</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78465062" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    while(m--){
        ...
        if(mp[first]){
            mp[second] = mp[first]%3 + 1;
            mp[third] = mp[second]%3 + 1;
        }
        else if(mp[second]){
            mp[first] = mp[second]%3 + 1;
            mp[third] = mp[first]%3 + 1;
        }
        else if(mp[third]){
            mp[first] = mp[third]%3 + 1;
            mp[second] = mp[first]%3 + 1;
        }
        else {mp[first] = 1; mp[second] = 2; mp[third] = 3;}
    }
