...
<head>
    ...
    <meta name="X-Csrf-Token" content="06582686f82f9c538c41a1bebd81cef9"/>
    ...
    <meta property="og:title" content="Submission #72028352 - Codeforces"/>
    ...
    <meta name="cc" content="191bf12606143fd2a58185825808232dd56d2b76"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #72028352 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='06582686f82f9c538c41a1bebd81cef9'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F115%2Fsubmission%2F72028352">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='06582686f82f9c538c41a1bebd81cef9'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-72028352" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int BFS(int s)
{
	...
	while(!q.empty()){
		...
		for(int i = 0; i < (int)adj[u].size(); i++){
			...
			q.push(adj[u][i]);
			levl[adj[u][i]] = levl[u] + 1;
			cnt = max(cnt, levl[u]+1);
		}
		visited[u] = 1;
	}
...
int main()
{
	...
	for(int i = 1; i <= n; i++){
		if(arr[i] == -1) level = max(level, BFS(i));
	}
