...
<head>
    ...
    <meta name="X-Csrf-Token" content="0285e4481c3bf63b76213ed3bf7028ca"/>
    ...
    <meta property="og:title" content="Submission #77148293 - Codeforces"/>
    ...
    <title>Submission #77148293 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='0285e4481c3bf63b76213ed3bf7028ca'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F466%2Fsubmission%2F77148293">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0285e4481c3bf63b76213ed3bf7028ca'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="C - Number of Ways" href="/contest/466/problem/C">466C</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-77148293" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    lli arr[n+5], pre[n+5], sum = 0, sum2 = 0, cnt[n+5];
