...
<head>
    ...
    <meta name="X-Csrf-Token" content="1a909c47b0917f75244a3de8bd604814"/>
    ...
    <meta property="og:title" content="Submission #71956444 - Codeforces"/>
    ...
    <title>Submission #71956444 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='1a909c47b0917f75244a3de8bd604814'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F479%2Fsubmission%2F71956444">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='1a909c47b0917f75244a3de8bd604814'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-71956444" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
	...
	int mn = min(v[0].first, v[0].second), d;
	
	for(int i = 1; i < n; i++){
		d = min(v[i].first, v[i].second);
		if(d < mn) mn = max(v[i].first, v[i].second);
		else mn = d;
	}
