...
<head>
    ...
    <meta name="X-Csrf-Token" content="8daaf04b0547103ac065552acddccfde"/>
    ...
    <meta property="og:title" content="Submission #80966719 - Codeforces"/>
    ...
    <meta name="cc" content="83b66616a32864ae0f5b54a602c6e773c371165a"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #80966719 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='8daaf04b0547103ac065552acddccfde'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F31%2Fsubmission%2F80966719">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='8daaf04b0547103ac065552acddccfde'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Sysadmin Bob" href="/contest/31/problem/B">31B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-80966719" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    int paisi = 0, cnt = 0, flag = 0;

    for(int i = 0; i < l; i++){
        if(s[i] == &#39;@&#39;){
            if(!cnt) {flag = 1; break;}
            if(ss[cnt-1] == &#39;@&#39;) {flag = 1; break;}
            ss += s[i];
            cnt++;
            paisi = 1;
        }
    ...
    if(l && cnt && !paisi) v[l-1] += ss;

    if(!l || flag) cout << "No solution" << "\n";
    else{
        for(int i = 0; i < l; i++){
            cout << v[i];
            if(i != l-1) cout << ",";
