...
<head>
    ...
    <meta name="X-Csrf-Token" content="6a9ecb0c3c505f915c657e8b11ce2117"/>
    ...
    <meta property="og:title" content="Submission #55217158 - Codeforces"/>
    ...
    <title>Submission #55217158 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='6a9ecb0c3c505f915c657e8b11ce2117'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F353%2Fsubmission%2F55217158">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='6a9ecb0c3c505f915c657e8b11ce2117'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-55217158" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
//  freopen("output.txt", "w", stdout);
    ...
    int n, a, b, odd1 = 0, even1 = 0, odd2 = 0, even2 = 0, odd = 0, d1, d2;
    ...
    int l = v.size();
    //cout << l << " " << odd1 << " " << odd2 << endl;
    if(l == 0 && odd%2 == 1) cout << -1 << endl, exit(0);
    else if(l == 0 || ((odd1+odd)%2 == 0 && (odd2+odd)%2 == 0)) cout << 0 << endl, exit(0);

    even1 = l-odd1; even2 = l-odd2;
    odd1 += odd; odd2 += odd;
    d1 = odd1%2; d2 = odd2%2;
