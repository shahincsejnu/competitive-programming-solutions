...
<head>
    ...
    <meta name="X-Csrf-Token" content="dbce020668cc6b2f1d66e5ca82f47c35"/>
    ...
    <meta property="og:title" content="Submission #78451405 - Codeforces"/>
    ...
    <title>Submission #78451405 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='dbce020668cc6b2f1d66e5ca82f47c35'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F469%2Fsubmission%2F78451405">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='dbce020668cc6b2f1d66e5ca82f47c35'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <td>2020-04-29 10:41:43</td>
    <td>2020-04-29 10:41:46</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78451405" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int p, q, l, r;
pair<int,int> PP[1005], QQ[1005];

bool Good(int val)
{
    for(int i = 1; i <= p; i++){
        for(int j = 1; j <= q; j++){
            int start = QQ[j].first+val, end = QQ[j].second+val;
            if(start >= PP[i].first && start <= PP[i].second) return true;
            if(end >= PP[i].first && end <= PP[i].second) return true;
            if(PP[i].first >= start && PP[i].first <= end) return true;
            if(PP[i].second >= start && PP[i].second <= end) return true;
        }
    }
    return false;
}
...
int main()
{
    ...
    for(int i = 1; i <= p; i++) cin >> PP[i].first >> PP[i].second;
