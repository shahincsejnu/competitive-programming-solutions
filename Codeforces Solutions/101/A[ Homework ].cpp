...
<head>
    ...
    <meta name="X-Csrf-Token" content="2148dec94509a3c1a861997707d82098"/>
    ...
    <meta property="og:title" content="Submission #54524852 - Codeforces"/>
    ...
    <meta name="cc" content="d556da0abaac5a406b0de2e0eeafcecd4101840f"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #54524852 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='2148dec94509a3c1a861997707d82098'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F101%2Fsubmission%2F54524852">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='2148dec94509a3c1a861997707d82098'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/101">Problems</a></li>
        <li><a
                                        href="/contest/101/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/101/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/101/status">Status</a></li>
        <li><a
                                        href="/contest/101/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/101/room/1">Room</a></li>
        <li><a
                                        href="/contest/101/standings">Standings</a></li>
        <li><a
                                        href="/contest/101/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="A - Homework" href="/contest/101/problem/A">101A</a>
    ...
    <td>2019-05-23 17:00:14</td>
    <td>2019-05-23 17:00:15</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-54524852" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
//  freopen("output.txt", "w", stdout);
    ...
    sort(v.begin(), v.end());
    int cnt, vs = v.size(), idx = 0;

    for(int i = 0; i < vs; i++){
        if(v[i].first <= k) {mp[v[i].second] = 0; idx = i+1; k-= v[i].first;}
        else{
            cnt = v[i].first-k; mp[v[i].second] = cnt; break;
        }
    }
//        if(v[i].first <= k) {k -= v[i].first; idx = i+1;}
//        else{
//            cnt = v[i].first - k; k = 0;
////            //for(int j = 0; j < cnt; j++) ans += v[i].second;
////            //ans += (cnt * v[i].second);
//////            string ss(cnt, v[i].second);
//////            ans += ss;
//        }
//    }

    for(int i = 0; i < sz; i++){
        if(mp[s[i]] != 0) {ans += s[i]; mp[s[i]]--;}
    }
