...
<head>
    ...
    <meta name="X-Csrf-Token" content="47249eb5449b61546f04de4031aa7257"/>
    ...
    <meta property="og:title" content="Submission #78460610 - Codeforces"/>
    ...
    <title>Submission #78460610 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='47249eb5449b61546f04de4031aa7257'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F122%2Fsubmission%2F78460610">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='47249eb5449b61546f04de4031aa7257'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Lucky Substring" href="/contest/122/problem/B">122B</a>
    ...
    <td>2020-04-29 12:39:15</td>
    <td>2020-04-29 12:39:17</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78460610" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int i = 1; i <= l; i++){
        for(int j = 0; j < l; j++){
        	string flag = "";
            for(int k = j; k < j+i and k < l; k++){
                if(s[k] == &#39;4&#39; || s[k] == &#39;7&#39;) flag += s[k];
                else break;
            }
            if(flag.size() == i){
               mp[flag]++;
