...
<head>
    ...
    <meta name="X-Csrf-Token" content="5d7d897fb84e256e08bd146317322f0e"/>
    ...
    <meta property="og:title" content="Submission #81714816 - Codeforces"/>
    ...
    <title>Submission #81714816 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='5d7d897fb84e256e08bd146317322f0e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F339%2Fsubmission%2F81714816">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='5d7d897fb84e256e08bd146317322f0e'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-81714816" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int val[11], m, arr[5000];

bool DFS(int pos, int prev_disi, int ekhon_dea_start)
{
    if(pos > m) return true;

    for(int i = ekhon_dea_start+1; i <= 10; i++){
        if(val[i] && i != prev_disi){
            arr[pos] = i;
            bool flag = DFS(pos+1, i, i-ekhon_dea_start);
            if(flag) return true;
        }
    }
