...
<head>
    ...
    <meta name="X-Csrf-Token" content="bc8e66c20c5673022ddcd9c9f257c645"/>
    ...
    <meta property="og:title" content="Submission #54652364 - Codeforces"/>
    ...
    <title>Submission #54652364 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='bc8e66c20c5673022ddcd9c9f257c645'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F476%2Fsubmission%2F54652364">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='bc8e66c20c5673022ddcd9c9f257c645'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-54652364" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
//  freopen("output.txt", "w", stdout);
    ...
    int sz = s1.size(), sum1 = 0, sum2 = 0, cnt = 0;
    ...
    for(int i = 0; i < l; i++){
        ...
        if((sum+sum2) == sum1) same++;
    }

    double ans = (double) same / (double) total;
