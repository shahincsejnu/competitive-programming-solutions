...
<head>
    ...
    <meta name="X-Csrf-Token" content="ca09395cc3b8114420d0d5d53fcb6c22"/>
    ...
    <meta property="og:title" content="Submission #72091052 - Codeforces"/>
    ...
    <meta name="cc" content="758bdb540edebc2e88f6010e65d3ad3b4eca28cc"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #72091052 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='ca09395cc3b8114420d0d5d53fcb6c22'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F507%2Fsubmission%2F72091052">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ca09395cc3b8114420d0d5d53fcb6c22'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Amr and Pins" href="/contest/507/problem/B">507B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-72091052" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
	...
	dis = (xx - x) * (xx - x) + (yy - y) * (yy - y);
	
	lli n_dis = sqrt(dis);
	
	if(n_dis * n_dis != dis) flag = 1;
