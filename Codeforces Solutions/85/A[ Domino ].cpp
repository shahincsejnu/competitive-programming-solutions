...
<head>
    ...
    <meta name="X-Csrf-Token" content="d943170ccc073eb89484b7a2ea9a23b4"/>
    ...
    <meta property="og:title" content="Submission #40553060 - Codeforces"/>
    ...
    <meta name="cc" content="272ba9d4fe8079726c1ec911befceb6fb4f39c59"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #40553060 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='d943170ccc073eb89484b7a2ea9a23b4'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F85%2Fsubmission%2F40553060">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d943170ccc073eb89484b7a2ea9a23b4'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/85">Problems</a></li>
        <li><a
                                        href="/contest/85/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/85/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/85/status">Status</a></li>
        <li><a
                                        href="/contest/85/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/85/room/1">Room</a></li>
        <li><a
                                        href="/contest/85/standings">Standings</a></li>
        <li><a
                                        href="/contest/85/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="A - Domino" href="/contest/85/problem/A">85A</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-40553060" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    string s1 = "", s2 = "", s3 = "", s4, aa = "aa", bb = "bb", xx = "xx", yy = "yy", zz = "zz", kk = "kk", ll = "ll";
    ...
    if(n%2){
        ...
        j = 1;
        for(int i = 2; i < n; i += 2){
            if(j == 1) { s2 += xx; s3 += kk; j = 2;}
            else {s2 += yy; s3 += ll; j = 1;}
        }
