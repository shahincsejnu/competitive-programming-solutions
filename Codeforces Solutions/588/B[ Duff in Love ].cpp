...
<head>
    ...
    <meta name="X-Csrf-Token" content="00ad422c790dc3245a07149cfc4a53ec"/>
    ...
    <meta property="og:title" content="Submission #77442511 - Codeforces"/>
    ...
    <meta name="cc" content="02a81a236ba1d04180512d713aa9abb2011abea1"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #77442511 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='00ad422c790dc3245a07149cfc4a53ec'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F588%2Fsubmission%2F77442511">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='00ad422c790dc3245a07149cfc4a53ec'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Duff in Love" href="/contest/588/problem/B">588B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-77442511" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    vector<lli> lovely_div;

    lli sq = sqrt(n+.5);

    for(lli i = 1; i <= sq; i++){
        if(n%i == 0){
            lovely_div.push_back(i);
            if((n/i) != i) lovely_div.push_back(n/i);
        }
    }

    SORT(lovely_div);

    int l = lovely_div.size();

    for(int i = l-1; i >= 0; i--){
        lli val = lovely_div[i];
        sq = sqrt(val+.5);
        int flag = 0;

        for(lli j = 2; j <= sq; j++){
            if(val%(j*j) == 0) {flag = 1; break;}
        }
