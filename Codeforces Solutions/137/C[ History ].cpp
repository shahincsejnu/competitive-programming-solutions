...
<head>
    ...
    <meta name="X-Csrf-Token" content="d95218d788f975c0636078eb4f00e1cc"/>
    ...
    <meta property="og:title" content="Submission #82352842 - Codeforces"/>
    ...
    <meta name="cc" content="aad3386b4b93c97169893b7ba9457bafcc04ece8"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #82352842 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='d95218d788f975c0636078eb4f00e1cc'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F137%2Fsubmission%2F82352842">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d95218d788f975c0636078eb4f00e1cc'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-82352842" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
void solve()
{
    ...
    int cnt = 0, mx_r = v[0].second;
    for(int i = 1; i < n; i++){
        if(v[i].second < mx_r) cnt++;
        mx_r = max(mx_r, v[i].second);
    }
