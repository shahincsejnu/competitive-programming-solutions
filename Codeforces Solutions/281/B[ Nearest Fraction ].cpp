...
<head>
    ...
    <meta name="X-Csrf-Token" content="cfb7c7eba900e98a602e65608f3e95d7"/>
    ...
    <meta property="og:title" content="Submission #78970564 - Codeforces"/>
    ...
    <title>Submission #78970564 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='cfb7c7eba900e98a602e65608f3e95d7'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F281%2Fsubmission%2F78970564">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='cfb7c7eba900e98a602e65608f3e95d7'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Nearest Fraction" href="/contest/281/problem/B">281B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78970564" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    lli ansx, ansy;
    double mn = 100000000000000.0;

    for(int a = 0, b = 1; b <= n; ){
        double ans1 = (x*1.0) / (y*1.0), ans2 = (a*1.0) / (b*1.0);
