...
<head>
    ...
    <meta name="X-Csrf-Token" content="fd7f869bb772b31e0a0a6292f3e39d15"/>
    ...
    <meta property="og:title" content="Submission #78478908 - Codeforces"/>
    ...
    <meta name="cc" content="7b628797bf70d65f7c1c69c898326c917429d3d8"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #78478908 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='fd7f869bb772b31e0a0a6292f3e39d15'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F359%2Fsubmission%2F78478908">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='fd7f869bb772b31e0a0a6292f3e39d15'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/359">Problems</a></li>
        <li><a
                                        href="/contest/359/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/359/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/359/status">Status</a></li>
        <li><a
                                        href="/contest/359/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/359/room/1">Room</a></li>
        <li><a
                                        href="/contest/359/standings">Standings</a></li>
        <li><a
                                        href="/contest/359/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Permutation" href="/contest/359/problem/B">359B</a>
    ...
    <td>2020-04-29 16:13:31</td>
    <td>2020-04-29 16:13:33</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78478908" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    int val = n;
    for(int i = 1; i <= n; i++) {arr[i] = val; val--;}
