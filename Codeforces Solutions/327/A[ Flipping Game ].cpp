...
<head>
    ...
    <meta name="X-Csrf-Token" content="4a092f8309cbd7f5ef65982ef77cf6ed"/>
    ...
    <meta property="og:title" content="Submission #54899762 - Codeforces"/>
    ...
    <meta name="cc" content="29a6270cd4d29ec14945bada4b2a781b27748f13"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #54899762 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='4a092f8309cbd7f5ef65982ef77cf6ed'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F327%2Fsubmission%2F54899762">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='4a092f8309cbd7f5ef65982ef77cf6ed'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-54899762" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
//  freopen("output.txt", "w", stdout);
    ...
    int cnt = 0, mx = 0, m_one = one;

    for(int i = 0; i < n; i++){
        if(cnt == 0 && a[i] == 1) continue;

        if(a[i] == 0) {cnt++; mx = max(mx, cnt+one);}
        if(a[i] == 1) cnt--;
    }
    if(mx == 0) mx = one-1;
