...
<head>
    ...
    <meta name="X-Csrf-Token" content="c66fbc2f2fb93ee3f5077e05cf144be9"/>
    ...
    <meta property="og:title" content="Submission #71992450 - Codeforces"/>
    ...
    <title>Submission #71992450 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='c66fbc2f2fb93ee3f5077e05cf144be9'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F546%2Fsubmission%2F71992450">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='c66fbc2f2fb93ee3f5077e05cf144be9'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-71992450" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
	...
	while(1){
		...
		if(dq1.empty()) {cout << cnt << " " << 2 << "\n"; break;}
		if(dq2.empty()) {cout << cnt << " " << 1 << "\n"; break;}
