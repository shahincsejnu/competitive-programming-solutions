...
<head>
    ...
    <meta name="X-Csrf-Token" content="05a3c46b1a8229d20c4dc9c0e177fa09"/>
    ...
    <meta property="og:title" content="Submission #83374658 - Codeforces"/>
    ...
    <title>Submission #83374658 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='05a3c46b1a8229d20c4dc9c0e177fa09'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F505%2Fsubmission%2F83374658">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='05a3c46b1a8229d20c4dc9c0e177fa09'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Mr. Kitayuta's Colorful Graph" href="/contest/505/problem/B">505B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-83374658" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
void DFS(int node, int color)
{
    ...
    for(auto son: adj[node]){
        if(!visited[son]){
            if(mp2[{{node, son}, color}]) DFS(son, color);
        }
    }
}
