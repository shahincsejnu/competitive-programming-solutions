...
<head>
    ...
    <meta name="X-Csrf-Token" content="9a2c871cba0cc64748f4172a30025728"/>
    ...
    <meta property="og:title" content="Submission #83378236 - Codeforces"/>
    ...
    <meta name="cc" content="357d3f84624cc44ba3143d1f132d7975c459ecf2"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #83378236 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='9a2c871cba0cc64748f4172a30025728'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F505%2Fsubmission%2F83378236">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='9a2c871cba0cc64748f4172a30025728'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="C - Mr. Kitayuta, the Treasure Hunter" href="/contest/505/problem/C">505C</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-83378236" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int dp[30111][2005], gem[30111], mx;

int call(int pos, int l)
{
    if(dp[pos][l] != -1) return dp[pos][l];

    int idx1 = pos+l-1, idx2 = pos+l, idx3 = pos+l+1, val1 = gem[pos], val2 = gem[pos], val3 = gem[pos];

    if(idx1 <= mx && l > 1) val1 += call(idx1, idx1-pos);
    if(idx2 <= mx && l) val2 += call(idx2, idx2-pos);
    if(idx3 <= mx) val3 += call(idx3, idx3-pos);

    return dp[pos][l] = max({val1, val2, val3});
}
