...
<head>
    ...
    <meta name="X-Csrf-Token" content="b5ac596edb419070cd0143fdd7746ac0"/>
    ...
    <meta property="og:title" content="Submission #35063627 - Codeforces"/>
    ...
    <title>Submission #35063627 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='b5ac596edb419070cd0143fdd7746ac0'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F382%2Fsubmission%2F35063627">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b5ac596edb419070cd0143fdd7746ac0'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="A - Ksenia and Pan Scales" href="/contest/382/problem/A">382A</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-35063627" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    if(s3.size() == s4.size()) cout << s3 << "|" << s4 << endl;
