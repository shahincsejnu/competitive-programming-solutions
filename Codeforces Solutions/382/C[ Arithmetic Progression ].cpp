...
<head>
    ...
    <meta name="X-Csrf-Token" content="b11f1000ea8e99c1bfc0b75e99f2db4e"/>
    ...
    <meta property="og:title" content="Submission #81476993 - Codeforces"/>
    ...
    <meta name="cc" content="65caf5df7814643c7da76e91faf56039ca5d41bd"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #81476993 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='b11f1000ea8e99c1bfc0b75e99f2db4e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F382%2Fsubmission%2F81476993">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b11f1000ea8e99c1bfc0b75e99f2db4e'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-81476993" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
void solve()
{
    ...
    int cnt = 1, dif = arr[2]-arr[1], val = -1e9, flag = 0, dif2 = -1e9;

    for(int i = 3; i <= n; i++){
        if(arr[i]-arr[i-1] != dif){
            if(arr[i]-arr[i-1] == dif2) continue;
            cnt++;
            dif2 = arr[i]-arr[i-1];
        }
    }
    ...
    if(cnt == 1){
        if(dif && dif%2 == 0 && n == 2){
            cout << 3 << "\n";
            cout << arr[1]-dif << " " << arr[1]+(dif/2) << " " << arr[2]+dif << "\n";
            exit(0);
        }
        if(dif == 0){
            cout << 1 << "\n";
    ...
    for(int i = 2; i <= n; i++){
        if(arr[i]-arr[i-1] == dif2) continue;
        val = arr[i-1] + dif2;
        if(arr[i]-val != dif2) {flag = 1; break;}
        else cnt++;
    }

    if(flag || cnt > 1) cout << 0 << "\n";
    else{
        cout << 1 << "\n";
        cout << val << "\n";
    }
