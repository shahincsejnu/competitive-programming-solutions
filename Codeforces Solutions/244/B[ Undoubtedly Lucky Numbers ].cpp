...
<head>
    ...
    <meta name="X-Csrf-Token" content="1512f90e23064c82c4d72aaf06eaff08"/>
    ...
    <meta property="og:title" content="Submission #79095984 - Codeforces"/>
    ...
    <meta name="cc" content="23fd594f1e9d1d29f9dd8c3ec1bfa396a2315238"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #79095984 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='1512f90e23064c82c4d72aaf06eaff08'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F244%2Fsubmission%2F79095984">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='1512f90e23064c82c4d72aaf06eaff08'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/244">Problems</a></li>
        <li><a
                                        href="/contest/244/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/244/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/244/status">Status</a></li>
        <li><a
                                        href="/contest/244/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/244/room/1">Room</a></li>
        <li><a
                                        href="/contest/244/standings">Standings</a></li>
        <li><a
                                        href="/contest/244/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Undoubtedly Lucky Numbers" href="/contest/244/problem/B">244B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-79095984" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
void Back(lli val)
{
    ...
    for(int i = 0; i <= 9; i++){
        lli n_val = val*10 + i;
        if(n_val && islucky(n_val)) Back(n_val);
    }
}
