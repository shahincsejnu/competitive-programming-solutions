...
<head>
    ...
    <meta name="X-Csrf-Token" content="6c9b784008fe78ba1ffe1915119d4d45"/>
    ...
    <meta property="og:title" content="Submission #78501139 - Codeforces"/>
    ...
    <title>Submission #78501139 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='6c9b784008fe78ba1ffe1915119d4d45'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F337%2Fsubmission%2F78501139">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='6c9b784008fe78ba1ffe1915119d4d45'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Routine Problem" href="/contest/337/problem/B">337B</a>
    ...
    <td>2020-04-29 20:04:34</td>
    <td>2020-04-29 20:04:37</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78501139" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    double div2 = (double)c / (double)d;

    if(div1 == div2) cout << 0 << "/1" << "\n";
    else if(div1 > div2){
