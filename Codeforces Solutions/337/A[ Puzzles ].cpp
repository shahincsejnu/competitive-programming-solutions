...
<head>
    ...
    <meta name="X-Csrf-Token" content="5a903f4d6781ed2d208f2ce06f92287e"/>
    ...
    <meta property="og:title" content="Submission #55413591 - Codeforces"/>
    ...
    <title>Submission #55413591 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='5a903f4d6781ed2d208f2ce06f92287e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F337%2Fsubmission%2F55413591">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='5a903f4d6781ed2d208f2ce06f92287e'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-55413591" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
	...
	int mn = 1e8;
	for(int i = 1; i <= m; i++){
		if((i+n-1) <= m) mn = min(mn, a[i+n-1]-a[i]);
	}
