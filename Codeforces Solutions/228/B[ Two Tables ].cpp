...
<head>
    ...
    <meta name="X-Csrf-Token" content="463bd45df985a17848c29683ccf52b41"/>
    ...
    <meta property="og:title" content="Submission #78612232 - Codeforces"/>
    ...
    <meta name="cc" content="c1855e787cca311b4fe95595e2e6e5f1776d1eca"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #78612232 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='463bd45df985a17848c29683ccf52b41'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F228%2Fsubmission%2F78612232">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='463bd45df985a17848c29683ccf52b41'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Two Tables" href="/contest/228/problem/B">228B</a>
    ...
    <td>2020-05-01 02:49:35</td>
    <td>2020-05-01 02:49:37</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78612232" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int xx = -50; xx <= 50; xx++){
        for(int yy = -50; yy <= 50; yy++){
            ...
            for(int i = 1; i <= na; i++){
                for(int j = 1; j <= ma; j++){
                    if(((i+xx) >= 1 && (i+xx) <= nb) && ((j+yy) >= 1 && (j+yy) <= mb)){
                    	sum += (ch1[i][j]-&#39;0&#39;) * (ch2[i+xx][j+yy]-&#39;0&#39;);
                    }
                }
            }
