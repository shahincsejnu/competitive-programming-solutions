...
<head>
    ...
    <meta name="X-Csrf-Token" content="554f20016d1f54786301408582354758"/>
    ...
    <meta property="og:title" content="Submission #81926680 - Codeforces"/>
    ...
    <meta name="cc" content="d276edd6147f6183f850d92a0f147ee8e8533001"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #81926680 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='554f20016d1f54786301408582354758'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F221%2Fsubmission%2F81926680">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='554f20016d1f54786301408582354758'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-81926680" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
void solve()
{
    ...
    for(int i = 1; i <= n; i++){
        if(arr[i] != brr[i] && pos1 == -1) pos1 = i;
        else if(arr[i] != brr[i]) {swap(arr[i], arr[pos1]); break;}
    }
