...
<head>
    ...
    <meta name="X-Csrf-Token" content="f14aeb327a991a8e466c36125abb6731"/>
    ...
    <meta property="og:title" content="Submission #54954860 - Codeforces"/>
    ...
    <title>Submission #54954860 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='f14aeb327a991a8e466c36125abb6731'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F96%2Fsubmission%2F54954860">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='f14aeb327a991a8e466c36125abb6731'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Lucky Numbers (easy)" href="/contest/96/problem/B">96B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-54954860" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
//  freopen("output.txt", "w", stdout);
    ...
    idx = lower_bound(v.begin(), v.end(), n) - v.begin();

    if(v[idx] >= n) cout << v[idx] << endl;
    else cout << v[idx+1] << endl;
