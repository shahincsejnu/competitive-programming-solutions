...
<head>
    ...
    <meta name="X-Csrf-Token" content="b305f7de616e41de2bb2af6f275c99a6"/>
    ...
    <meta property="og:title" content="Submission #77641792 - Codeforces"/>
    ...
    <title>Submission #77641792 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='b305f7de616e41de2bb2af6f275c99a6'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F486%2Fsubmission%2F77641792">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b305f7de616e41de2bb2af6f275c99a6'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - OR in Matrix" href="/contest/486/problem/B">486B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-77641792" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int i = 1; i <= m; i++){
        for(int j = 1; j <= n; j++){
        	if(arr[i][j]) continue;
            int row = i, col = j;
            for(int r = 1; r <= n; r++) brr[row][r] = 0;
            for(int c = 1; c <= m; c++) brr[c][col] = 0;
        }
    }
    ...
    for(int i = 1; i <= m; i++){
        for(int j = 1; j <= n; j++){
            ...
            cnt = 0;
            for(int r = 1; r <= n; r++){
                if(brr[row][r] == -1) {cnt = 1; break;}
            }
            for(int c = 1; c <= m; c++){
                if(brr[c][col] == -1) {cnt = 1; break;}
            }
