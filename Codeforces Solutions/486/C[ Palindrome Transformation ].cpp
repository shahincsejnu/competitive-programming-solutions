...
<head>
    ...
    <meta name="X-Csrf-Token" content="d7e72b117ab544e4026b6108eb1bb7de"/>
    ...
    <meta property="og:title" content="Submission #81171054 - Codeforces"/>
    ...
    <title>Submission #81171054 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='d7e72b117ab544e4026b6108eb1bb7de'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F486%2Fsubmission%2F81171054">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d7e72b117ab544e4026b6108eb1bb7de'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-81171054" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    if(p <= nn){
        for(int i = 0; i < nn; i++){
            if(s[i] != s[n-i-1] && l == -1) {l = i; r = i;}
            if(s[i] != s[n-i-1] && l != -1) r = i;
        }
    }
    else{
        for(int i = nn; i < n; i++){
    ...
    p--;
    if(l != -1) ans = min(abs(p-l), abs(p-r)) + (r-l);
