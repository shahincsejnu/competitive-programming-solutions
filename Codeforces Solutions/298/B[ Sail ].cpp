...
<head>
    ...
    <meta name="X-Csrf-Token" content="3a7d314968263160d527e434832d438c"/>
    ...
    <meta property="og:title" content="Submission #55411908 - Codeforces"/>
    ...
    <meta name="cc" content="4521c7755e3b6b3f368534c813c12de0c3ec8335"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #55411908 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='3a7d314968263160d527e434832d438c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F298%2Fsubmission%2F55411908">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='3a7d314968263160d527e434832d438c'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-55411908" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
	...
	for(int i = 0; i < t; i++){
		if(s[i] == &#39;S&#39;){
			if(sy != ey && (abs((sy-1)-ey) < abs(sy-ey))) sy--;
		}
		else if(s[i] == &#39;E&#39;){
			if(sx != ex && (abs((sx+1)-ex) < abs(sx-ex))) sx++;
		}
		else if(s[i] == &#39;W&#39;){
			if(sx != ex && (abs((sx-1)-ex) < abs(sx-ex))) sx--;
		}
