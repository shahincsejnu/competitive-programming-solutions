...
<head>
    ...
    <meta name="X-Csrf-Token" content="d6a824a93110ff56e6f48c1bb06bc7bb"/>
    ...
    <meta property="og:title" content="Submission #75662208 - Codeforces"/>
    ...
    <meta name="cc" content="dc55112dee1b1f0081cd049d7c9048c28f25f5cc"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #75662208 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='d6a824a93110ff56e6f48c1bb06bc7bb'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F5%2Fsubmission%2F75662208">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d6a824a93110ff56e6f48c1bb06bc7bb'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-75662208" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
{	
	...
	for(int i = 0; i < l; i++){
		if(st.empty() || s[i] == &#39;(&#39;) {st.push(s[i]); st2.push(i+1);}
		else{
			if(st.top() == &#39;(&#39;){
				st.pop();
				st2.pop();
