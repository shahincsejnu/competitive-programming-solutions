...
<head>
    ...
    <meta name="X-Csrf-Token" content="b5fc0169138dd3ecfa4eaaee02f2552c"/>
    ...
    <meta property="og:title" content="Submission #81154381 - Codeforces"/>
    ...
    <title>Submission #81154381 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='b5fc0169138dd3ecfa4eaaee02f2552c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F441%2Fsubmission%2F81154381">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b5fc0169138dd3ecfa4eaaee02f2552c'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="C - Valera and Tubes " href="/contest/441/problem/C">441C</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-81154381" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int i = 1; i <= n; i++){
        if(i%2) {start = 1; end = m;}
        else {start = m; end = 1;}

        for(int j = start;;){
            if(i%2 && j > end) break;
            else if(i%2 == 0 && j < end) break;
    ...
    for(int i = 1; i <= kk; i++){
        ...
        cout << l/2 << " ";
        for(int j = 0; j < l; j += 2) cout << v[i][j] << " " << v[i][j+1] << " ";
        cout << "\n";
    }
