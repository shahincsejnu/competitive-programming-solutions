...
<head>
    ...
    <meta name="X-Csrf-Token" content="221f04bc070188b4fee3aa5152693389"/>
    ...
    <meta property="og:title" content="Submission #64627956 - Codeforces"/>
    ...
    <title>Submission #64627956 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='221f04bc070188b4fee3aa5152693389'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F598%2Fsubmission%2F64627956">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='221f04bc070188b4fee3aa5152693389'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-64627956" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
void DFS(int x, int y)
{
	...
	mp[{x, y}] = cnt;
	if((y+1) <= m && ch[x][y+1] != ch[x][y]) ans++;
	if((y-1) >= 1 && ch[x][y-1] != ch[x][y]) ans++;
	if((x-1) >= 1 && ch[x-1][y] != ch[x][y]) ans++;
	if((x+1) <= n && ch[x+1][y] != ch[x][y]) ans++;
	vis[x][y] = 1;
