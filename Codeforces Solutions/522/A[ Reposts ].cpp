...
<head>
    ...
    <meta name="X-Csrf-Token" content="e724ab331aadb640f253c7ae546e7cd4"/>
    ...
    <meta property="og:title" content="Submission #54642311 - Codeforces"/>
    ...
    <meta name="cc" content="4a5f8c76b1f43cb930fa8580b3ee5f5e983178c5"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #54642311 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='e724ab331aadb640f253c7ae546e7cd4'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    <div style="float:left;">
            <div><a href="/vkcup2015"><img src="//assets.codeforces.com/images/star-vkcup-2015-300.png"/></a></div>
    </div>
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F522%2Fsubmission%2F54642311">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='e724ab331aadb640f253c7ae546e7cd4'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-54642311" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
//  freopen("output.txt", "w", stdout);
    ...
    mp["POLYCARP"] = "POLYCARP";
    mp2["POLYCARP"] = 1;

    for(int i = 0; i < n; i++){
        cin >> n1 >> r >> n2;

        for(int i = 0; i < n1.size(); i++) n1[i] = toupper(n1[i]);
        for(int i = 0; i < n2.size(); i++) n2[i] = toupper(n2[i]);
