...
<head>
    ...
    <meta name="X-Csrf-Token" content="ba5e7dffbcf9a30cb0f80413c77a7b75"/>
    ...
    <meta property="og:title" content="Submission #78323353 - Codeforces"/>
    ...
    <title>Submission #78323353 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='ba5e7dffbcf9a30cb0f80413c77a7b75'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F362%2Fsubmission%2F78323353">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ba5e7dffbcf9a30cb0f80413c77a7b75'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <td>2020-04-27 22:02:01</td>
    <td>2020-04-27 22:02:02</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78323353" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int i = 1; i <= m-2; i++){
        if((arr[i]+1) == arr[i+1] && (arr[i+1]+1) == arr[i+2]) flag = false;
    }
    
    if(arr[m] == n || arr[1] == 1) flag = false;
