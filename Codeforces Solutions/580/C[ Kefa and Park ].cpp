...
<head>
    ...
    <meta name="X-Csrf-Token" content="0d19056e5408a73a101f7b4df312eb48"/>
    ...
    <meta property="og:title" content="Submission #61458636 - Codeforces"/>
    ...
    <title>Submission #61458636 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='0d19056e5408a73a101f7b4df312eb48'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F580%2Fsubmission%2F61458636">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0d19056e5408a73a101f7b4df312eb48'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <td>2019-09-29 10:35:56</td>
    <td>2019-09-29 10:36:00</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-61458636" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
const int M = 1e5 + 5;
int arr[M], m;
vector<int> adj[M], res;
bool visited[M];

void DFS(int s, int val)
{
    //cout << s << " = " << val << "\n";
    if(adj[s].size() == 1 && s != 1) res.push_back(val);
    if(!visited[s]){
        visited[s] = true;
