...
<head>
    ...
    <meta name="X-Csrf-Token" content="6b735951b7324be87ad6464907d5d69a"/>
    ...
    <meta property="og:title" content="Submission #71472671 - Codeforces"/>
    ...
    <title>Submission #71472671 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='6b735951b7324be87ad6464907d5d69a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F580%2Fsubmission%2F71472671">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='6b735951b7324be87ad6464907d5d69a'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-71472671" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
	...
	lli sum = v[0].second, mx = sum, asi = 0, dd;
	
	for(int i = 1; i < n; i++){
		t = v[i].first; f = v[i].second;
