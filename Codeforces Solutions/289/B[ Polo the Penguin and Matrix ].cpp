...
<head>
    ...
    <meta name="X-Csrf-Token" content="c47c89374661f0b84bf09c68ad02b3fa"/>
    ...
    <meta property="og:title" content="Submission #54881285 - Codeforces"/>
    ...
    <meta name="cc" content="92d430901faeaa056a4e22437fee3625e2673bca"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #54881285 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='c47c89374661f0b84bf09c68ad02b3fa'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F289%2Fsubmission%2F54881285">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='c47c89374661f0b84bf09c68ad02b3fa'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Polo the Penguin and Matrix" href="/contest/289/problem/B">289B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-54881285" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
//  freopen("output.txt", "w", stdout);
    ...
    int l = v.size(), sz = l/2, sum = 0, div;

    for(int i = 0; i < l; i++){
        if(i == sz) continue;

        div = abs(v[i]-v[sz]);
        if(div%d) {sum = -1; break;}
