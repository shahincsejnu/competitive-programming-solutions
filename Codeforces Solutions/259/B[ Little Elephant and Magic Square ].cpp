...
<head>
    ...
    <meta name="X-Csrf-Token" content="142d097fbfa7435db018ec417c6cdcd6"/>
    ...
    <meta property="og:title" content="Submission #78320809 - Codeforces"/>
    ...
    <meta name="cc" content="118c64716a5120f9f025c7f9c6415ab316bf3829"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #78320809 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='142d097fbfa7435db018ec417c6cdcd6'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F259%2Fsubmission%2F78320809">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='142d097fbfa7435db018ec417c6cdcd6'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Little Elephant and Magic Square" href="/contest/259/problem/B">259B</a>
    ...
    <td>2020-04-27 21:24:19</td>
    <td>2020-04-27 21:24:20</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78320809" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    arr[2][2] = (arr[1][3]+arr[3][1]) / 2;
    arr[3][3] = arr[1][2]+arr[1][3] - arr[2][2];
    arr[1][1] = arr[2][2] + arr[3][2] - arr[1][3];
