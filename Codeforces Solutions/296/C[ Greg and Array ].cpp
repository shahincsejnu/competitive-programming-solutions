...
<head>
    ...
    <meta name="X-Csrf-Token" content="0c72d38a0325b6b3d2387378afa216e8"/>
    ...
    <meta property="og:title" content="Submission #82745722 - Codeforces"/>
    ...
    <meta name="cc" content="d18ab78915d6b2e19bf412336368fc3c5382eb24"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #82745722 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='0c72d38a0325b6b3d2387378afa216e8'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F296%2Fsubmission%2F82745722">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0c72d38a0325b6b3d2387378afa216e8'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/296">Problems</a></li>
        <li><a
                                        href="/contest/296/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/296/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/296/status">Status</a></li>
        <li><a
                                        href="/contest/296/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/296/room/1">Room</a></li>
        <li><a
                                        href="/contest/296/standings">Standings</a></li>
        <li><a
                                        href="/contest/296/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="C - Greg and Array" href="/contest/296/problem/C">296C</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-82745722" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
void solve()
{
    ...
    lli arr[n+5] = {0}, brr[n+5];
    for(int i = 1; i <= n; i++) cin >> brr[i];
    
    vector< pair<lli, lli> > v;
    v.push_back({0, 0});
    vector<lli> v2(m+5, 0), v3(m+5, 0);
