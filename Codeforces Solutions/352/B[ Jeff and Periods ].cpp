...
<head>
    ...
    <meta name="X-Csrf-Token" content="897ea0c4fe97528897ed0c4b38082c5d"/>
    ...
    <meta property="og:title" content="Submission #55413122 - Codeforces"/>
    ...
    <title>Submission #55413122 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='897ea0c4fe97528897ed0c4b38082c5d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F352%2Fsubmission%2F55413122">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='897ea0c4fe97528897ed0c4b38082c5d'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-55413122" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
	...
	for(auto it = mp.begin(); it != mp.end(); it++){
		...
		if(sz == 1) mp2[it->first] = 0;
		else if(sz == 2) mp2[it->first] = it->second[1] - it->second[0];
		else{
			d = it->second[1]-it->second[0]; flag = 0;
			for(int i = 2; i < sz; i++){
				if(it->second[i]-it->second[i-1] != d){
					flag = 1; break;
				}
			}
			if(!flag) mp2[it->first] = d;
		}
	}
