...
<head>
    ...
    <meta name="X-Csrf-Token" content="df874c12090a9d6633eacbdd548b3906"/>
    ...
    <meta property="og:title" content="Submission #78456703 - Codeforces"/>
    ...
    <title>Submission #78456703 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='df874c12090a9d6633eacbdd548b3906'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F157%2Fsubmission%2F78456703">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='df874c12090a9d6633eacbdd548b3906'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <td>2020-04-29 11:51:53</td>
    <td>2020-04-29 11:51:55</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78456703" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    double ans = PI, val = 0.0;

    for(int i = 1; i <= n; i++){
        if(i%2) val += arr[i]*arr[i];
        else val -= arr[i]*arr[i]; 
    }
