...
<head>
    ...
    <meta name="X-Csrf-Token" content="da78ee452fd912edd9aa29d74ee18ed2"/>
    ...
    <meta property="og:title" content="Submission #72027127 - Codeforces"/>
    ...
    <meta name="cc" content="00c598a8f3b70a1444c966839a24863d8f9d8440"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #72027127 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='da78ee452fd912edd9aa29d74ee18ed2'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F514%2Fsubmission%2F72027127">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='da78ee452fd912edd9aa29d74ee18ed2'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-72027127" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
	...
	int l = s.size(), val1, val2;
	
	for(int i = 0; i < l; i++){
		val1 = s[i]-&#39;0&#39;;
		val2 = 9-val1;
		
		if(i == 0 && val2 == 0) continue;
