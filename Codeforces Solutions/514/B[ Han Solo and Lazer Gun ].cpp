...
<head>
    ...
    <meta name="X-Csrf-Token" content="a59e89a1948045020daffc99ef0b5ef3"/>
    ...
    <meta property="og:title" content="Submission #72119024 - Codeforces"/>
    ...
    <title>Submission #72119024 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='a59e89a1948045020daffc99ef0b5ef3'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F514%2Fsubmission%2F72119024">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a59e89a1948045020daffc99ef0b5ef3'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-72119024" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
	...
	for(int i = 0; i < n; i++){
		...
		if(y == y0) {flag = 1; continue;}
		double d = (y-y0) / (x-x0);
		
		mp[d]++;
	}
	
	cout << mp.size() + flag + cnt << "\n";
