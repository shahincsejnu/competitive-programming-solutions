...
<head>
    ...
    <meta name="X-Csrf-Token" content="75ad04d66a25827c7ee4c11fe838095c"/>
    ...
    <meta property="og:title" content="Submission #83723916 - Codeforces"/>
    ...
    <title>Submission #83723916 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='75ad04d66a25827c7ee4c11fe838095c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F276%2Fsubmission%2F83723916">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='75ad04d66a25827c7ee4c11fe838095c'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="D - Little Girl and Maximum XOR" href="/contest/276/problem/D">276D</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-83723916" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
void solve()
{
    ...
    if(l == r) ans = 0;
    else if(__builtin_popcountll(r) == 1) ans = r ^ (r-1);
    else{
        ans = l ^ r;
        lli pos = __builtin_clzll(ans);
        ans = 64-pos;
        ans = 1ll << ans;
        ans--;
    }
