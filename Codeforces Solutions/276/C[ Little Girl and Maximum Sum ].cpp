...
<head>
    ...
    <meta name="X-Csrf-Token" content="a723d44165fa62704bb2ec177e109a52"/>
    ...
    <meta property="og:title" content="Submission #77297394 - Codeforces"/>
    ...
    <title>Submission #77297394 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='a723d44165fa62704bb2ec177e109a52'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F276%2Fsubmission%2F77297394">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a723d44165fa62704bb2ec177e109a52'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-77297394" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
bool myfunc(const pair<lli,lli> &i, const pair<lli,lli> &j)
{
...
int main()
{
    ...
    lli arr[n+5], crr[n+5] = {0};
    for(int i = 1; i <= n; i++) cin >> arr[i]; 

    lli brr[n+5] = {0}, l, r;
    
    vector< pair<lli,lli> > query, max_query;
    ...
    for(int i = 2; i <= n; i++) brr[i] += brr[i-1];
    for(int i = 1; i <= n; i++) max_query.push_back(make_pair(brr[i], i));
    
    sort(max_query.begin(), max_query.end(), myfunc);
    sort(arr+1, arr+n+1);

    for(int i = n, j = 0; i >= 1; i--, j++){
        int idx = max_query[j].second;
        crr[idx] = arr[i];
    }
    ...
    for(int i = 0; i < q; i++){
        sum += (crr[query[i].second] - crr[query[i].first-1]);
    }
