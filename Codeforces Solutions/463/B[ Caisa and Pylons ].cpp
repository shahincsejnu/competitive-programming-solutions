...
<head>
    ...
    <meta name="X-Csrf-Token" content="6eb8775e7a6547bcee6203d870670d1b"/>
    ...
    <meta property="og:title" content="Submission #72073749 - Codeforces"/>
    ...
    <title>Submission #72073749 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='6eb8775e7a6547bcee6203d870670d1b'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F463%2Fsubmission%2F72073749">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='6eb8775e7a6547bcee6203d870670d1b'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-72073749" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
	...
	lli n, val, ans = 0, hand = 0, energy = 0;
	...
	for(int i = 0; i < n; i++){
		...
		if(val <= hand) {energy = hand - val; hand = val;}
		else {energy = 0; ans += val - hand; hand = val;}
	}
