...
<head>
    ...
    <meta name="X-Csrf-Token" content="56ec02011bc8b7af9c4e7dfe2ad5fe38"/>
    ...
    <meta property="og:title" content="Submission #58549260 - Codeforces"/>
    ...
    <meta name="cc" content="464cd1102e4b4f7073d9d3e9bdf8b27ad597097b"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #58549260 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='56ec02011bc8b7af9c4e7dfe2ad5fe38'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F13%2Fsubmission%2F58549260">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='56ec02011bc8b7af9c4e7dfe2ad5fe38'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/13">Problems</a></li>
        <li><a
                                        href="/contest/13/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/13/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/13/status">Status</a></li>
        <li><a
                                        href="/contest/13/standings">Standings</a></li>
        <li><a
                                        href="/contest/13/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="E - Holes" href="/contest/13/problem/E">13E</a>
    ...
    <td>2019-08-10 21:37:30</td>
    <td>2019-08-10 21:37:31</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-58549260" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
const int M = 5e5 + 5;
int arr[M], block[M], block_jabo[M], block_real_jabo[M];
...
int main()
{
    ...
    int last_block = (n-1)/block_size;
 
    for(int i = 0; i < n; i++) cin >> arr[i];
 
    int block_end, block_number, jabo, block_start;
 
    for(int i = n-1; i >= 0; i--){
        block_number = i/block_size;
        block_end = ((block_number+1) * block_size) - 1;
        ...
        if(jabo > block_end){
            block[i] = 1; block_jabo[i] = jabo;
            block_real_jabo[i]=i+1;
        }
        else{
            block[i] = block[jabo] + 1;
            block_jabo[i] = block_jabo[jabo];
            block_real_jabo[i]=block_real_jabo[jabo];
        }
    }
