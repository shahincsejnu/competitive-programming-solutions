...
<head>
    ...
    <meta name="X-Csrf-Token" content="9ac84dcd783e269eb1fbfd2e990edc9e"/>
    ...
    <meta property="og:title" content="Submission #78469778 - Codeforces"/>
    ...
    <meta name="cc" content="600a263e27dabbc514f35394d5ba88f772830be7"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #78469778 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='9ac84dcd783e269eb1fbfd2e990edc9e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F416%2Fsubmission%2F78469778">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='9ac84dcd783e269eb1fbfd2e990edc9e'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/416">Problems</a></li>
        <li><a
                                        href="/contest/416/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/416/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/416/status">Status</a></li>
        <li><a
                                        href="/contest/416/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/416/room/1">Room</a></li>
        <li><a
                                        href="/contest/416/standings">Standings</a></li>
        <li><a
                                        href="/contest/416/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Art Union" href="/contest/416/problem/B">416B</a>
    ...
    <td>2020-04-29 14:28:44</td>
    <td>2020-04-29 14:28:46</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78469778" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int i = 1; i <= n; i++){
        for(int j = 1; j <= m; j++){
        	int cur_free;
        	if(i == 1) cur_free = 0;
        	else cur_free = v[j][i-1];

        	if(j == 1) prev_free = 0;
        	else prev_free = v[j-1][i];

            int cur_start = max(prev_free, cur_free);

            v[j][i] = cur_start + v[j][i];
        }
    }
