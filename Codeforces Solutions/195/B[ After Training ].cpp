...
<head>
    ...
    <meta name="X-Csrf-Token" content="b6da058adab1f45406de5ff052d77324"/>
    ...
    <meta property="og:title" content="Submission #78795676 - Codeforces"/>
    ...
    <meta name="cc" content="2c5dc6e946789df02df6c1765652e7c63f6a4cee"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #78795676 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='b6da058adab1f45406de5ff052d77324'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F195%2Fsubmission%2F78795676">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b6da058adab1f45406de5ff052d77324'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/195">Problems</a></li>
        <li><a
                                        href="/contest/195/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/195/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/195/status">Status</a></li>
        <li><a
                                        href="/contest/195/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/195/room/1">Room</a></li>
        <li><a
                                        href="/contest/195/standings">Standings</a></li>
        <li><a
                                        href="/contest/195/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - After Training" href="/contest/195/problem/B">195B</a>
    ...
    <td>2020-05-02 11:01:39</td>
    <td>2020-05-02 11:01:48</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78795676" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int i = middle-1; i >= 1; i--){
    	if(m%2){
	        v.push_back(i);
	        middle_right++;
	        v.push_back(middle_right);
	    }
	    else{
	        middle_right++;
	        v.push_back(middle_right);
	        v.push_back(i);
            if(i == 1) {v.push_back(middle_right+1); middle_right++;}
	    }
    }

    if(middle_right+1 <= m) v.push_back(middle_right+1);
    
    int l = v.size(), start = 1;
