...
<head>
    ...
    <meta name="X-Csrf-Token" content="b8de69e2b681e49c3bbd3e36e9e2b46a"/>
    ...
    <meta property="og:title" content="Submission #54569418 - Codeforces"/>
    ...
    <meta name="cc" content="6b4443e04233ec3929f91c6a244537fe3e4e3a2f"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #54569418 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='b8de69e2b681e49c3bbd3e36e9e2b46a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F6%2Fsubmission%2F54569418">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b8de69e2b681e49c3bbd3e36e9e2b46a'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="A - Triangle" href="/contest/6/problem/A">6A</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-54569418" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
//  freopen("output.txt", "w", stdout);
    ...
    for(int i = 0; i < 4; i++){
        ...
        else if(i == 1) {a = aa; b = bb; c = dd;}
        else if(i == 2) {a = aa; b = cc; c = dd;}
        else {a = bb; b = cc; c = dd;}
        ...
        if(ans < 0.0) mp[3] = 1;
        else if(ans == 0.0) mp[2] = 1;
        else mp[1] = 1;
    }

    if(mp[1]) cout << "TRIANGLE" << endl;
    else if(mp[2]) cout << "SEGMENT" << endl;
