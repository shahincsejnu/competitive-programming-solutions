...
<head>
    ...
    <meta name="X-Csrf-Token" content="ee180eaf5fe6923049a84b39034bdbb8"/>
    ...
    <meta property="og:title" content="Submission #58549347 - Codeforces"/>
    ...
    <meta name="cc" content="4c4c8bec8b536dbb0812512f77b7f149531bf472"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #58549347 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='ee180eaf5fe6923049a84b39034bdbb8'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F398%2Fsubmission%2F58549347">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ee180eaf5fe6923049a84b39034bdbb8'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/398">Problems</a></li>
        <li><a
                                        href="/contest/398/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/398/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/398/status">Status</a></li>
        <li><a
                                        href="/contest/398/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/398/room/1">Room</a></li>
        <li><a
                                        href="/contest/398/standings">Standings</a></li>
        <li><a
                                        href="/contest/398/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="D - Instant Messanger" href="/contest/398/problem/D">398D</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-58549347" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
const int M = 1e5 + 5;
int online[M], online_light_frnd_count[M], heavy_or_light[M];
unordered_set<int> adj[M], heavy_set;

void lightupdate(int n, int cnt)
{
	for(int it : adj[n]){
		online_light_frnd_count[it] += cnt;
	}
}
...
int main()
{
	...
	for(int i = 1; i <= n; i++){
		if(online[i] == 1 && heavy_or_light[i] == 0) lightupdate(i, 1);
	}
	...
	while(q--){
		...
		if(ch == &#39;O&#39;){
			cin >> u;
			if(!heavy_or_light[u]) lightupdate(u, 1); 
			online[u] = 1;
		}
			...
			l1 = adj[v].size();
			if(l1 <= LIMIT && online[v]) online_light_frnd_count[u]++;
			
			l2 = adj[u].size();
			if(l2 <= LIMIT && online[u]) online_light_frnd_count[v]++;
			
			if(l1-1 == LIMIT) {heavy_or_light[u] = 1; heavy_set.insert(u); lightupdate(v, -1);}
			
			if(l2-1 == LIMIT) {heavy_or_light[v] = 1; heavy_set.insert(v); lightupdate(u, -1);}
		}
			...
			if(l1 == LIMIT) {heavy_or_light[v] = 0; heavy_set.erase(v); lightupdate(v, 1);}
			
			if(l2 == LIMIT) {heavy_or_light[u] = 0; heavy_set.erase(u); lightupdate(u, 1);}
		}
		
		else{
			cin >> u;
			
			int ans = online_light_frnd_count[u];
			
			for(int it : heavy_set){
				if(adj[u].find(it) != adj[u].end() && online[it]) ans++;
			}
