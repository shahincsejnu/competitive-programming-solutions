...
<head>
    ...
    <meta name="X-Csrf-Token" content="67838a573a969a44c191d02daa4c14e3"/>
    ...
    <meta property="og:title" content="Submission #81958349 - Codeforces"/>
    ...
    <meta name="cc" content="54a8216fa6ef31faddd9642436412e2250e5c45d"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #81958349 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='67838a573a969a44c191d02daa4c14e3'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F371%2Fsubmission%2F81958349">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='67838a573a969a44c191d02daa4c14e3'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/371">Problems</a></li>
        <li><a
                                        href="/contest/371/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/371/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/371/status">Status</a></li>
        <li><a
                                        href="/contest/371/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/371/room/1">Room</a></li>
        <li><a
                                        href="/contest/371/standings">Standings</a></li>
        <li><a
                                        href="/contest/371/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="C - Hamburgers" href="/contest/371/problem/C">371C</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-81958349" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
void solve()
{
    ...
    lli start = 0, end = 1e15, mid;

    while(start <= end){
        mid = (start + end) / 2;

        lli bb = B*mid, ss = S*mid, cc = C*mid;

        bb = max(bb-nb, 0ll);
        ss = max(ss-ns, 0ll);
        cc = max(cc-nc, 0ll);

        lli taka = bb*pb + ss*ps + cc*pc;
