...
<head>
    ...
    <meta name="X-Csrf-Token" content="6374da8ba202595e7d3a4ea8c91fd24b"/>
    ...
    <meta property="og:title" content="Submission #35957678 - Codeforces"/>
    ...
    <meta name="cc" content="aadad61d94ddaab61077e373e570db431beeb5b8"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #35957678 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='6374da8ba202595e7d3a4ea8c91fd24b'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F302%2Fsubmission%2F35957678">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='6374da8ba202595e7d3a4ea8c91fd24b'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/302">Problems</a></li>
        <li><a
                                        href="/contest/302/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/302/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/302/status">Status</a></li>
        <li><a
                                        href="/contest/302/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/302/room/1">Room</a></li>
        <li><a
                                        href="/contest/302/standings">Standings</a></li>
        <li><a
                                        href="/contest/302/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="A - Eugeny and Array" href="/contest/302/problem/A">302A</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-35957678" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int i = 0; i < q; i++){
        ...
        if(mo >= d/2 && o >= d/2 && d%2 == 0) cout << 1 << endl;
        else cout << 0 << endl;
    }
