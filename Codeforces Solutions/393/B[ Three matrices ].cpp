...
<head>
    ...
    <meta name="X-Csrf-Token" content="ba3e5a495d1de62d916a06fb82b68426"/>
    ...
    <meta property="og:title" content="Submission #81004761 - Codeforces"/>
    ...
    <meta name="cc" content="614b317ae8519af135177a01c6e4a1ce6a0de1f1"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #81004761 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='ba3e5a495d1de62d916a06fb82b68426'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F393%2Fsubmission%2F81004761">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ba3e5a495d1de62d916a06fb82b68426'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/393">Problems</a></li>
        <li><a
                                        href="/contest/393/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/393/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/393/status">Status</a></li>
        <li><a
                                        href="/contest/393/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/393/room/1">Room</a></li>
        <li><a
                                        href="/contest/393/standings">Standings</a></li>
        <li><a
                                        href="/contest/393/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Three matrices" href="/contest/393/problem/B">393B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-81004761" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    double arr[n+5][n+5], brr[n+5][n+5], crr[n+5][n+5];
    for(int i = 1; i <= n; i++){
       for(int j = 1; j <= n; j++){
           cin >> arr[i][j];
           if(i == j) {brr[i][j] = arr[i][j]; crr[i][j] = 0.0;}
       }
    }

    for(int i = 1; i <= n; i++){
        for(int j = i+1; j <= n; j++){
            double x = arr[i][j] + arr[j][i];
            x /= 2;
            brr[i][j] = x;
            brr[j][i] = x;
    ...
    for(int i = 1; i <= n; i++){
        for(int j = 1; j <= n; j++){
            cout << fixed << setprecision(8) << brr[i][j] << " ";
        }
        cout << "\n";
    }
    ...
    for(int i = 1; i <= n; i++){
        for(int j = 1; j <= n; j++){
            cout << fixed << setprecision(8) << crr[i][j] << " ";
        }
        cout << "\n";
    }
