...
<head>
    ...
    <meta name="X-Csrf-Token" content="bc99642fd3b83da29678baa8529968f1"/>
    ...
    <meta property="og:title" content="Submission #72083756 - Codeforces"/>
    ...
    <meta name="cc" content="82aa17f000ac3448ababc929fb967b83197f06e8"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #72083756 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='bc99642fd3b83da29678baa8529968f1'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F431%2Fsubmission%2F72083756">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='bc99642fd3b83da29678baa8529968f1'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="C - k-Tree" href="/contest/431/problem/C">431C</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-72083756" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int func(int sum, int check)
{
	if(sum > n) return dp[sum][check] = 0;
	if(sum == n){
		if(check) return dp[sum][check] = 1;
		else return dp[sum][check] = 0;
	}
	...
	for(int i = 1; i <= k; i++){
		if(sum+i <= n){
			if(i >= d) ans = (ans + func(sum+i, 1)) % MOD	;
			else ans = (ans + func(sum+i, check)) % MOD;
		}
	}
