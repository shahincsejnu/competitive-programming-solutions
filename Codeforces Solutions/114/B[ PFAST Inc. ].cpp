...
<head>
    ...
    <meta name="X-Csrf-Token" content="88bdff87cdd416696b4cc8c5a813c016"/>
    ...
    <meta property="og:title" content="Submission #80947635 - Codeforces"/>
    ...
    <title>Submission #80947635 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='88bdff87cdd416696b4cc8c5a813c016'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F114%2Fsubmission%2F80947635">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='88bdff87cdd416696b4cc8c5a813c016'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - PFAST Inc." href="/contest/114/problem/B">114B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-80947635" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
    ...
    for(int i = 0; i < (1<<n); i++){
        ...
        for(int ii = 0; ii < l; ii++){
            for(int j = ii+1; j < l; j++){
                if(mp2[{v1[v[ii]], v1[v[j]]}] || mp2[{v1[v[j]], v1[v[ii]]}]) {flag = 1; break;}
            }
            if(flag) break;
        }

        if(!flag && cnt > mx_cnt) {mx_cnt = cnt; mx = i;} 
    }
