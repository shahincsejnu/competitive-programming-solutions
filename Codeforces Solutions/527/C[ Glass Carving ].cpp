...
<head>
    ...
    <meta name="X-Csrf-Token" content="7210b8c3b448b67e68388afce79574ff"/>
    ...
    <meta property="og:title" content="Submission #80684416 - Codeforces"/>
    ...
    <meta name="cc" content="29379b537c04d6fd6487dce61d17f831c83637ae"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #80684416 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='7210b8c3b448b67e68388afce79574ff'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F527%2Fsubmission%2F80684416">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='7210b8c3b448b67e68388afce79574ff'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="C - Glass Carving" href="/contest/527/problem/C">527C</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-80684416" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    int Lh[h+5], Rh[h+5], Lv[w+5], Rv[w+5];
    vector<int> horizontal, vertical;
    vector< pair<char, int> > v;

    while(n--){
        cin >> ch >> x;
        v.push_back(make_pair(ch, x));

        if(ch == &#39;H&#39;) horizontal.push_back(x);
        else vertical.push_back(x);
    }

    int l1 = horizontal.size(), l2 = vertical.size();
    ...
    for(int i = l1-1; i >= 0; i--){
        if(i == l1-1){
            Rh[horizontal[i]] = h;
            Lh[horizontal[i]] = 0;
            if(i > 0) Lh[horizontal[i]] = horizontal[i-1];
        }
        else{
            Rh[horizontal[i]] = horizontal[i+1];
            Lh[horizontal[i]] = 0;
            if(i > 0) Lh[horizontal[i]] = horizontal[i-1];
        }

        mx = max({mx, Rh[horizontal[i]] - horizontal[i], horizontal[i] - Lh[horizontal[i]]});
    }
    if(mx == -1) mx = h;
    ...
    for(int i = l2-1; i >= 0; i--){
        if(i == l2-1){
            Rv[vertical[i]] = w;
            Lv[vertical[i]] = 0;
            if(i > 0) Lv[vertical[i]] = vertical[i-1];
        }
        else{
            Rv[vertical[i]] = vertical[i+1];
            Lv[vertical[i]] = 0;
            if(i > 0) Lv[vertical[i]] = vertical[i-1];
        }

        my = max({my, Rv[vertical[i]] - vertical[i], vertical[i] - Lv[vertical[i]]});
    }
    if(my == -1) my = w;
