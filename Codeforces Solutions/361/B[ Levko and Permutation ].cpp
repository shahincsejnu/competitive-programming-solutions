...
<head>
    ...
    <meta name="X-Csrf-Token" content="ca641a0c083adaaa3e4667deee1503ef"/>
    ...
    <meta property="og:title" content="Submission #78478364 - Codeforces"/>
    ...
    <meta name="cc" content="f15d3f53153b7125587a5a98e4324a7c8c2fd3b7"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #78478364 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='ca641a0c083adaaa3e4667deee1503ef'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F361%2Fsubmission%2F78478364">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ca641a0c083adaaa3e4667deee1503ef'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/361">Problems</a></li>
        <li><a
                                        href="/contest/361/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/361/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/361/status">Status</a></li>
        <li><a
                                        href="/contest/361/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/361/room/1">Room</a></li>
        <li><a
                                        href="/contest/361/standings">Standings</a></li>
        <li><a
                                        href="/contest/361/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Levko and Permutation" href="/contest/361/problem/B">361B</a>
    ...
    <td>2020-04-29 16:07:19</td>
    <td>2020-04-29 16:07:22</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78478364" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int j = i; j <= n; j += 2){
        if(j == n) {arr[j] = 1; arr[1] = j;}
        else {arr[j] = j+1; arr[j+1] = j;}
    }
