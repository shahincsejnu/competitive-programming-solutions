...
<head>
    ...
    <meta name="X-Csrf-Token" content="c8461cf85f4dc3bb327995c20f347a93"/>
    ...
    <meta property="og:title" content="Submission #71980789 - Codeforces"/>
    ...
    <meta name="cc" content="f6d71b7d2e1ca20a139b8cb1327da29f5e2bfc5f"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #71980789 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='c8461cf85f4dc3bb327995c20f347a93'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F545%2Fsubmission%2F71980789">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='c8461cf85f4dc3bb327995c20f347a93'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="C - Woodcutters" href="/contest/545/problem/C">545C</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-71980789" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
	...
	int asi = v[0].first, cnt = 2, d, xx, hh, dd;
	
	for(int i = 1; i < n-1; i++){
		x = v[i].first; h = v[i].second;
		xx = v[i+1].first; hh = v[i+1].second;
		
		d = x - asi - 1;
		d = min(d, x - v[i-1].first - 1);
		dd = xx - x - 1;
		
		if(h <= d) {cnt++; asi = x;}
		else if(h <= dd) {cnt++; asi = x + h;}
	}
