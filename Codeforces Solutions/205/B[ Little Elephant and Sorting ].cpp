...
<head>
    ...
    <meta name="X-Csrf-Token" content="5d7249d9c529452f4ce03eaf4fe7bba3"/>
    ...
    <meta property="og:title" content="Submission #78482203 - Codeforces"/>
    ...
    <title>Submission #78482203 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='5d7249d9c529452f4ce03eaf4fe7bba3'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F205%2Fsubmission%2F78482203">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='5d7249d9c529452f4ce03eaf4fe7bba3'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Little Elephant and Sorting" href="/contest/205/problem/B">205B</a>
    ...
    <td>2020-04-29 16:50:19</td>
    <td>2020-04-29 16:50:21</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78482203" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int i = 2; i <= n; i++){
        arr[i] += nisi;
        if(arr[i] < arr[i-1]) {sum += arr[i-1]-arr[i]; nisi += arr[i-1]-arr[i];}
        else continue;
        arr[i] = arr[i-1];
    }
