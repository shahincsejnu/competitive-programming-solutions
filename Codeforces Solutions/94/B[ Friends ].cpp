...
<head>
    ...
    <meta name="X-Csrf-Token" content="46e6c1d44d2c509fa2250eb40f29933c"/>
    ...
    <meta property="og:title" content="Submission #79094261 - Codeforces"/>
    ...
    <meta name="cc" content="5404777f8fef1027a18e7309dae3ba91f79748d5"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #79094261 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='46e6c1d44d2c509fa2250eb40f29933c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F94%2Fsubmission%2F79094261">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='46e6c1d44d2c509fa2250eb40f29933c'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/94">Problems</a></li>
        <li><a
                                        href="/contest/94/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/94/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/94/status">Status</a></li>
        <li><a
                                        href="/contest/94/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/94/room/1">Room</a></li>
        <li><a
                                        href="/contest/94/standings">Standings</a></li>
        <li><a
                                        href="/contest/94/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Friends" href="/contest/94/problem/B">94B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-79094261" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
    ...
    for(int i = 1; i <= 5; i++){
        for(int j = 1; j <= 5; j++){
            for(int k = 1; k <= 5; k++){
                ...
                if(mp[{i, j}] && mp[{j, k}] && mp[{i, k}]) {flag = 1; break;}
                if(!mp[{i, j}] && !mp[{j, k}] && !mp[{i, k}]) {flag = 1; break;}
            }
            if(flag) break;
        }
