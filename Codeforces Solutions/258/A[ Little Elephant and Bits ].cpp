...
<head>
    ...
    <meta name="X-Csrf-Token" content="85631f1e1aaf743bb722c321d0bfcaf4"/>
    ...
    <meta property="og:title" content="Submission #55411444 - Codeforces"/>
    ...
    <title>Submission #55411444 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='85631f1e1aaf743bb722c321d0bfcaf4'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F258%2Fsubmission%2F55411444">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='85631f1e1aaf743bb722c321d0bfcaf4'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-55411444" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
	...
	for(int i = 0; i < sz; i++){
		if(s[i] == &#39;0&#39;) {s[i] = &#39;2&#39;; break;}
		if(i == sz - 1) s[i] = &#39;2&#39;;
	}
	
	for(int i = 0; i < sz; i++) {if(s[i] != &#39;2&#39;) cout << s[i];}
	cout << "\n";
