...
<head>
    ...
    <meta name="X-Csrf-Token" content="32b435cc8d25484ac8d96384194b2147"/>
    ...
    <meta property="og:title" content="Submission #35170542 - Codeforces"/>
    ...
    <title>Submission #35170542 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='32b435cc8d25484ac8d96384194b2147'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F478%2Fsubmission%2F35170542">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='32b435cc8d25484ac8d96384194b2147'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-35170542" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    lli n, m, mn = 0, mx, porse_per_team, extra_ase, besi_ase_team_k_team_e, team_sonkha, team_baki_ase, new_mn;
    ...
    if(extra_ase)
    {
        besi_ase_team_k_team_e = porse_per_team;
        team_sonkha = extra_ase;
        team_baki_ase = m-team_sonkha;
        mn = (besi_ase_team_k_team_e *(besi_ase_team_k_team_e+1))/2;
        mn = mn*team_sonkha;
    }

    else team_baki_ase = m;
    porse_per_team--;
    new_mn = (porse_per_team * (porse_per_team+1))/2;
    mn += (new_mn*team_baki_ase);
