...
<head>
    ...
    <meta name="X-Csrf-Token" content="3d62c99b15eb543606cbb700a961b6e5"/>
    ...
    <meta property="og:title" content="Submission #77319814 - Codeforces"/>
    ...
    <title>Submission #77319814 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='3d62c99b15eb543606cbb700a961b6e5'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F478%2Fsubmission%2F77319814">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='3d62c99b15eb543606cbb700a961b6e5'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="C - Table Decorations" href="/contest/478/problem/C">478C</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-77319814" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    if(arr[2] >= (2*(arr[0]+arr[1]))) ans = arr[0]+arr[1];
    else ans = (r+g+b)/3;
