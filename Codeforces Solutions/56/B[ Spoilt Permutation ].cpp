...
<head>
    ...
    <meta name="X-Csrf-Token" content="5ec2343b88dfa23a564e329d9c76551d"/>
    ...
    <meta property="og:title" content="Submission #80942455 - Codeforces"/>
    ...
    <title>Submission #80942455 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='5ec2343b88dfa23a564e329d9c76551d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F56%2Fsubmission%2F80942455">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='5ec2343b88dfa23a564e329d9c76551d'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-80942455" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int i = 1; i <= n; i++){
        cin >> arr[i];
        if(arr[i] != i && l == -1) {l = i; r = arr[i];}
    }
    
    if(l != -1) reverse(arr+l, arr+r+1);
