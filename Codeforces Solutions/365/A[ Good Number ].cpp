...
<head>
    ...
    <meta name="X-Csrf-Token" content="d37462b81abe9f5e924080530e65f44f"/>
    ...
    <meta property="og:title" content="Submission #35219992 - Codeforces"/>
    ...
    <title>Submission #35219992 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='d37462b81abe9f5e924080530e65f44f'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F365%2Fsubmission%2F35219992">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d37462b81abe9f5e924080530e65f44f'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="A - Good Number" href="/contest/365/problem/A">365A</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-35219992" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int i = 0; i < n; i++){
        ...
        l = s.size(); c = 0;
        for(int j = 0; j <= k; j++){
            if(find(s.begin(), s.end(), j+&#39;0&#39;) == s.end()){
                c = 1; break;
            }
        }
        if(!c) cnt++;
