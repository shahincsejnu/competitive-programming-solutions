...
<head>
    ...
    <meta name="X-Csrf-Token" content="8a236ae397be2322c2921d89e210bfd5"/>
    ...
    <meta property="og:title" content="Submission #78531285 - Codeforces"/>
    ...
    <meta name="cc" content="60afa0da1e35353771c1e84f72538a7208622022"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #78531285 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='8a236ae397be2322c2921d89e210bfd5'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F349%2Fsubmission%2F78531285">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='8a236ae397be2322c2921d89e210bfd5'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Color the Fence" href="/contest/349/problem/B">349B</a>
    ...
    <td>2020-04-30 06:43:41</td>
    <td>2020-04-30 06:43:44</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78531285" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int i = 0; i < d; i++){
        ...
        int idx2 = -1;
        for(int j = 9; j >= 1; j--){
            if(arr[j] <= dd) {dd -= arr[j]; idx2 = j; break;}
        }
        if(idx2 == -1) break;
        ans1[i] = idx2+&#39;0&#39;;
    }
