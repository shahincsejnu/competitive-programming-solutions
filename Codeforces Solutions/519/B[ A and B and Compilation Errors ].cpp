...
<head>
    ...
    <meta name="X-Csrf-Token" content="ff35e81a5296535cbb0a9353ca2ec89a"/>
    ...
    <meta property="og:title" content="Submission #71196127 - Codeforces"/>
    ...
    <title>Submission #71196127 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='ff35e81a5296535cbb0a9353ca2ec89a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F519%2Fsubmission%2F71196127">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ff35e81a5296535cbb0a9353ca2ec89a'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-71196127" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    lli sum1 = 0, sum2 = 0, sum3 = 0, val;

    for(int i = 0; i < n; i++) {cin >> val; sum1 += val;}
    for(int i = 0; i < n-1; i++) {cin >> val; sum2 += val;}
    for(int i = 0; i < n-2; i++) {cin >> val; sum3 += val;}
