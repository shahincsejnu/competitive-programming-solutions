...
<head>
    ...
    <meta name="X-Csrf-Token" content="d75bd507b17929f9865fc4176af04b3b"/>
    ...
    <meta property="og:title" content="Submission #78876885 - Codeforces"/>
    ...
    <title>Submission #78876885 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='d75bd507b17929f9865fc4176af04b3b'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F342%2Fsubmission%2F78876885">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d75bd507b17929f9865fc4176af04b3b'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Xenia and Spies" href="/contest/342/problem/B">342B</a>
    ...
    <td>2020-05-03 12:45:47</td>
    <td>2020-05-03 12:45:50</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78876885" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    int n, m, s, f, t, l, r, prev_ase, step = 1;
    ...
    for(int i = 1; i <= m; i++){
        ...
        if(step != t){
            ...
            if(f < s){
                if((prev_ase-1 < l || prev_ase-1 > r) && !(prev_ase >= l && prev_ase <= r)){
                    prev_ase--;
                    cout << "L";
                }
                else cout << "X";
    ...
    while(prev_ase != f){
        if(prev_ase > f) {cout << "L"; prev_ase--;}
        if(prev_ase < f) {cout << "R"; prev_ase++;}
    }
    cout << "\n";
