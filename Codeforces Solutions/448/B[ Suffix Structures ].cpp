...
<head>
    ...
    <meta name="X-Csrf-Token" content="88b6540034cdf8936012233ccff8cbc3"/>
    ...
    <meta property="og:title" content="Submission #77462749 - Codeforces"/>
    ...
    <meta name="cc" content="a9d93e8e82d97ac785e9901bc5e22e0f67677857"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #77462749 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='88b6540034cdf8936012233ccff8cbc3'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F448%2Fsubmission%2F77462749">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='88b6540034cdf8936012233ccff8cbc3'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Suffix Structures" href="/contest/448/problem/B">448B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-77462749" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    int l1 = s1.size(), l2 = s2.size(), cnt = 0;

    for(int i = 0; i < l1; i++) mp1[s1[i]]++;
    for(int i = 0; i < l2; i++) mp2[s2[i]]++;

    for(int i = 0; i < l2; i++){
        int cnt1 = mp2[s2[i]];
        if(mp1[s2[i]] < cnt1) {flag = 1; break;}
    }
