...
<head>
    ...
    <meta name="X-Csrf-Token" content="6992bf5086eb973708d3cf17f5cd078b"/>
    ...
    <meta property="og:title" content="Submission #77133593 - Codeforces"/>
    ...
    <meta name="cc" content="27a4d2ba703d32df75e24d56ae4d963ea3f7f023"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #77133593 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='6992bf5086eb973708d3cf17f5cd078b'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F378%2Fsubmission%2F77133593">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='6992bf5086eb973708d3cf17f5cd078b'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="C - Maze" href="/contest/378/problem/C">378C</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-77133593" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int n, m, k, s, cnt, visited[505][505];
char ch[505][505];

bool DFS(int x, int y)
{
	if(x > n || x < 1 || y > m || y < 1) return false;
	if(visited[x][y] || ch[x][y] == &#39;#&#39;) return false;
