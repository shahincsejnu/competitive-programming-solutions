...
<head>
    ...
    <meta name="X-Csrf-Token" content="b72b132b10e0134d3c41e0da20f30fa3"/>
    ...
    <meta property="og:title" content="Submission #61933603 - Codeforces"/>
    ...
    <meta name="cc" content="8649a3d9bb866eaf7db9cbad53d5349c0e26136e"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #61933603 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='b72b132b10e0134d3c41e0da20f30fa3'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F381%2Fsubmission%2F61933603">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b72b132b10e0134d3c41e0da20f30fa3'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-61933603" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
	...
	int i = 0, j = n-1, move = 0;
	
	while(i <= j){
		if(move == 0){
			move = 1;
			if(arr[i] > arr[j]) {s += arr[i]; i++;}
			else {s += arr[j]; j--;}
		}
		else{
			move = 0;
			if(arr[i] > arr[j]) {d += arr[i]; i++;}
			else {d += arr[j]; j--;}
		}
	}
