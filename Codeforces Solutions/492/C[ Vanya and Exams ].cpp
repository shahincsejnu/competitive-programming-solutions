...
<head>
    ...
    <meta name="X-Csrf-Token" content="85b7f1d2b1880d2626eda9d54406f663"/>
    ...
    <meta property="og:title" content="Submission #84360026 - Codeforces"/>
    ...
    <title>Submission #84360026 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='85b7f1d2b1880d2626eda9d54406f663'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F492%2Fsubmission%2F84360026">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='85b7f1d2b1880d2626eda9d54406f663'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-84360026" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
void solve()
{
    ...
    for(int i = 0; i < n; i++){
        ...
        lli start = 0, end = r-v[i].second, mid, ans = 0;

        while(start <= end){
            mid = (start+end)/2;
            lli val2 = (total+mid)/n;
