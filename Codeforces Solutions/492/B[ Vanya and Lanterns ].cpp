...
<head>
    ...
    <meta name="X-Csrf-Token" content="c2e133cab0f1f758019c6fda8bd86073"/>
    ...
    <meta property="og:title" content="Submission #54570913 - Codeforces"/>
    ...
    <meta name="cc" content="038e0740b52dabd9cb78ccef16026c0f9529c771"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #54570913 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='c2e133cab0f1f758019c6fda8bd86073'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F492%2Fsubmission%2F54570913">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='c2e133cab0f1f758019c6fda8bd86073'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Vanya and Lanterns" href="/contest/492/problem/B">492B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-54570913" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
double B_S(double lo, double up)
{
    double mid;
    ...
    while((up-lo) > 1e-10){
        ...
        int flag = 0;
        double left, right, last = 0.0;

        for(int i = 0; i < n; i++){
            left = (double)a[i] - mid;
            right = (double)a[i] + mid;

            if(left > last) {flag = 1; break;}
            if(i == n-1 && right < l) {flag = 1; break;}
            last = right;
        }
