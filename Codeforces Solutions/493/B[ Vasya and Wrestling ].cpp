...
<head>
    ...
    <meta name="X-Csrf-Token" content="0909f318cc8dfee2d65fffb0eaada045"/>
    ...
    <meta property="og:title" content="Submission #78454454 - Codeforces"/>
    ...
    <title>Submission #78454454 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='0909f318cc8dfee2d65fffb0eaada045'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F493%2Fsubmission%2F78454454">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0909f318cc8dfee2d65fffb0eaada045'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <td>2020-04-29 11:22:32</td>
    <td>2020-04-29 11:22:33</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78454454" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    lli sum1 = 0, sum2 = 0, val;
    int flag = 0;

    while(n--){
        cin >> val;
        if(val > 0) {v1.push_back(val); sum1 += val; flag = 1;}
        if(val < 0) {val *= -1; v2.push_back(val); sum2 += val; flag = 2;}
    }

    if(sum1 > sum2) cout << "first" << "\n", exit(0);
    if(sum2 > sum1) cout << "second" << "\n", exit(0);
    
    int l1 = v1.size(), l2 = v2.size(), flag2 = 0;

    int l = min(l1, l2);

    for(int i = 0; i < l; i++){
        if(v1[i] > v2[i]) {flag2 = 1; break;}
        if(v2[i] > v1[i]) {flag2 = 2; break;}
    }
