...
<head>
    ...
    <meta name="X-Csrf-Token" content="9d7fc2cbb649b3fdd96121853aba3176"/>
    ...
    <meta property="og:title" content="Submission #78657599 - Codeforces"/>
    ...
    <title>Submission #78657599 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='9d7fc2cbb649b3fdd96121853aba3176'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F231%2Fsubmission%2F78657599">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='9d7fc2cbb649b3fdd96121853aba3176'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Magic, Wizardry and Wonders" href="/contest/231/problem/B">231B</a>
    ...
    <td>2020-05-01 16:32:58</td>
    <td>2020-05-01 16:33:02</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78657599" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    lli odd = n/2, even = n/2;

    if(n%2) odd++;

    lli mn = odd - (even*l), mx = (odd*l) - even;
