...
<head>
    ...
    <meta name="X-Csrf-Token" content="c915297d411b3c71dec9481fe32c938b"/>
    ...
    <meta property="og:title" content="Submission #77168427 - Codeforces"/>
    ...
    <title>Submission #77168427 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='c915297d411b3c71dec9481fe32c938b'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F474%2Fsubmission%2F77168427">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='c915297d411b3c71dec9481fe32c938b'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-77168427" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
lli func(lli n)
{
    ...
    return dp[n] = (func(n-k)%MOD + func(n-1)%MOD) % MOD;
}
...
int main()
{
    ...
    for(int i = 1; i <= 100000; i++) pre[i] = func(i)%MOD;
    for(int i = 2; i <= 100000; i++) pre[i] = (pre[i]+pre[i-1])%MOD;

    while(t--){
        cin >> a >> b;
         
        lli ans = pre[b]-pre[a-1];
        ans = (ans+MOD) % MOD;
