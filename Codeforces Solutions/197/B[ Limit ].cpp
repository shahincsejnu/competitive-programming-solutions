...
<head>
    ...
    <meta name="X-Csrf-Token" content="bdf117810c493828b715c97f37035619"/>
    ...
    <meta property="og:title" content="Submission #78627353 - Codeforces"/>
    ...
    <meta name="cc" content="292fbea94e92cb2251f0c8a9328a348503490cbf"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #78627353 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='bdf117810c493828b715c97f37035619'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F197%2Fsubmission%2F78627353">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='bdf117810c493828b715c97f37035619'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Limit" href="/contest/197/problem/B">197B</a>
    ...
    <td>2020-05-01 09:29:11</td>
    <td>2020-05-01 09:29:13</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-78627353" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    int gcd = __gcd(abs(arr[1]), abs(brr[1]));

    if(brr[1] < 0) gcd *= -1;

    if(m > n) cout << 0 << "/" << 1 << "\n";
    else if(n > m){
        if((arr[1]*brr[1]) < 0) cout << "-Infinity" << "\n";
        else cout << "Infinity" << "\n";
    }
    else cout << arr[1]/gcd << "/" << brr[1]/gcd << "\n";
