...
<head>
    ...
    <meta name="X-Csrf-Token" content="ac175f6dc429ee27086af0bd3dedcf5e"/>
    ...
    <meta property="og:title" content="Submission #71195758 - Codeforces"/>
    ...
    <title>Submission #71195758 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='ac175f6dc429ee27086af0bd3dedcf5e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F499%2Fsubmission%2F71195758">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ac175f6dc429ee27086af0bd3dedcf5e'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-71195758" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
