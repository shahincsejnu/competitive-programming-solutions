...
<head>
    ...
    <meta name="X-Csrf-Token" content="aa8c7ab713891d75d950486b05427ae3"/>
    ...
    <meta property="og:title" content="Submission #72262822 - Codeforces"/>
    ...
    <meta name="cc" content="13bc6f99cc19b3f46206c3c75aee7234ea0743e5"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #72262822 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='aa8c7ab713891d75d950486b05427ae3'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F454%2Fsubmission%2F72262822">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='aa8c7ab713891d75d950486b05427ae3'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="B - Little Pony and Sort by Shift" href="/contest/454/problem/B">454B</a>
         - <span title="problem revision">58</span>
    </td>
    <td>
    GNU C++11
    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-72262822" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
	...
	for(i = 1; i < n; i++){
		if(arr[i] >= arr[i-1]) v1.push_back(arr[i]);
		else break;
	}
	...
	int l2 = v2.size(), l1 = v1.size();
	
	for(int j = 0; j < l1; j++) v2.push_back(v1[j]);
