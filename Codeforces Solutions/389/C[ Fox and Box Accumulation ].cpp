...
<head>
    ...
    <meta name="X-Csrf-Token" content="753757c8a7736d9e3734e5b46e47c1e9"/>
    ...
    <meta property="og:title" content="Submission #81698594 - Codeforces"/>
    ...
    <title>Submission #81698594 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='753757c8a7736d9e3734e5b46e47c1e9'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F389%2Fsubmission%2F81698594">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='753757c8a7736d9e3734e5b46e47c1e9'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-81698594" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
void solve()
{
    ...
    int arr[n+5], brr[n+5];
    for(int i = 1; i <= n; i++) {cin >> arr[i]; brr[i] = 1;}
