...
<head>
    ...
    <meta name="X-Csrf-Token" content="f731f6dcfc7187ca4528b7dd6f6c9b9a"/>
    ...
    <meta property="og:title" content="Submission #82351869 - Codeforces"/>
    ...
    <title>Submission #82351869 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='f731f6dcfc7187ca4528b7dd6f6c9b9a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F385%2Fsubmission%2F82351869">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='f731f6dcfc7187ca4528b7dd6f6c9b9a'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="C - Bear and Prime Numbers" href="/contest/385/problem/C">385C</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-82351869" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
void SIEVE_2()
{
    ...
    for(int i = 0; i < l; i++){
        int val = prime[i], cnt = 0;
        for(int j = val; j <= 10000000; j += val){
            cnt += check[j];
        }
        mp[val] = cnt;
    }
