...
<head>
    ...
    <meta name="X-Csrf-Token" content="468cf83efa92104a2949c673957fb22e"/>
    ...
    <meta property="og:title" content="Submission #34995920 - Codeforces"/>
    ...
    <title>Submission #34995920 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='468cf83efa92104a2949c673957fb22e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F166%2Fsubmission%2F34995920">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='468cf83efa92104a2949c673957fb22e'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="A - Rank List" href="/contest/166/problem/A">166A</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-34995920" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    int pp = P[k-1].first, tt = P[k-1].second, cnt = 0;

    for(int i = 0; i < n; i++){
        if(P[i].first == pp && P[i].second == tt) cnt++;
    }
