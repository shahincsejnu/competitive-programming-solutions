...
<head>
    ...
    <meta name="X-Csrf-Token" content="5b5004483ac2487ebaffc08727ec9429"/>
    ...
    <meta property="og:title" content="Submission #77207757 - Codeforces"/>
    ...
    <meta name="cc" content="a642e5527b957904531dd57f4fa501280f9411bf"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #77207757 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='5b5004483ac2487ebaffc08727ec9429'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F166%2Fsubmission%2F77207757">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='5b5004483ac2487ebaffc08727ec9429'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="E - Tetrahedron" href="/contest/166/problem/E">166E</a>
    ...
    <td>2020-04-18 20:12:43</td>
    <td>2020-04-18 20:17:27</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-77207757" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int i = 2; i <= n; i++) {mul = (mul*3) %MOD; dp[i] = (mul - dp[i-1]) %MOD; dp[i] = (dp[i] + MOD) %MOD;}
