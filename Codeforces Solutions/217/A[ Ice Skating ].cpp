...
<head>
    ...
    <meta name="X-Csrf-Token" content="6e3bd4f1437290770d866018c417b059"/>
    ...
    <meta property="og:title" content="Submission #54597935 - Codeforces"/>
    ...
    <meta name="cc" content="adcab98582b07086c5df6a75582b5ba063296ed7"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #54597935 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='6e3bd4f1437290770d866018c417b059'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F217%2Fsubmission%2F54597935">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='6e3bd4f1437290770d866018c417b059'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/217">Problems</a></li>
        <li><a
                                        href="/contest/217/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/217/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/217/status">Status</a></li>
        <li><a
                                        href="/contest/217/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/217/room/1">Room</a></li>
        <li><a
                                        href="/contest/217/standings">Standings</a></li>
        <li><a
                                        href="/contest/217/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    <td>
        <a title="A - Ice Skating" href="/contest/217/problem/A">217A</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-54597935" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
//  freopen("output.txt", "w", stdout);
    ...
    for(int i = 1; i <= mx; i++){
        hand = -1;
        for(int j = 1; j <= mx; j++){
            if(matrix[i][j] && hand == -1) hand = matrix[i][j];
            else if(matrix[i][j]){
                adj[hand].push_back(matrix[i][j]);
                adj[matrix[i][j]].push_back(hand);
                hand = matrix[i][j];
            }
        }
        hand = -1;
        for(int j = 1; j <= mx; j++){
            if(matrix[j][i] && hand == -1) hand = matrix[j][i];
            else if(matrix[j][i]){
                adj[hand].push_back(matrix[j][i]);
                adj[matrix[j][i]].push_back(hand);
                hand = matrix[j][i];
            }
        }
    }
