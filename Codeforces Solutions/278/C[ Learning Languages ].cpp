...
<head>
    ...
    <meta name="X-Csrf-Token" content="55e7d217a3520452ee669ee706750873"/>
    ...
    <meta property="og:title" content="Submission #77026812 - Codeforces"/>
    ...
    <meta name="cc" content="fbd1ec07fe32e73423346538d104e1716e946e89"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #77026812 - Codeforces</title>
...
<body class=" "><span style='display:none;' class='csrf-token' data-csrf='55e7d217a3520452ee669ee706750873'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F278%2Fsubmission%2F77026812">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='55e7d217a3520452ee669ee706750873'/>
...
<a href="/profile/shahincsejnu" title="Newbie shahincsejnu" class="rated-user user-gray">shahincsejnu</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-77026812" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(int i = 1; i <= n; i++)
    {
        ...
        {
            cin >> lan;
            language[lan].push_back(i);
        }
    }

    for(int i = 1; i <= m; i++)
    {
        int l = language[i].size();

        for(int j = 1; j < l; j++)
        {
            union_set(language[i][j], language[i][j-1]);
        }
    }
